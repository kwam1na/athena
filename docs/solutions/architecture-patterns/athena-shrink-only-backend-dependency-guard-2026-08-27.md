...
related_components:
  ...
  - "agentHarness"
  - "operationAdmission"
delivery_diff_fingerprint: "c3660847d9ff0f651920a9b3ab0d96088bd541b4bc78dab45506acbf6456ed4b"
---
...
- **Reduced scan coverage is never silent (P3).** Unreadable source files are counted and warned (stderr) instead of skipped invisibly — an unreadable kernel file could hide forbidden imports.
...
- `scripts/convex-backend-dependency-check.test.ts` — Test suite (37 sandbox-based scenarios + real-tree characterization)
