...
## Summary
- 5824 nodes · 6147 edges · 1716 communities detected
...
10. `useRegisterViewModel()` - 13 edges
...
Cohesion: 0.07
Nodes (26): addLocalAvailabilityConsumption(), addLocalAvailabilityDeltaConsumption(), asCloudOperableSession(), buildCompletedSalePayload(), buildLocalAvailabilityEventIndex(), cartItemsFromLocalRegisterModel(), completedCustomerInfo(), countPendingSyncableLocalEventsForStaff() (+18 more)
