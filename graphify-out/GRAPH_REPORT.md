...
## Summary
- 14600 nodes · 18059 edges · 3241 communities detected
...
- **Thin community `Community 1941`** (2 nodes): `posHubFixtures.ts`, `buildTrend()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1942`** (2 nodes): `formatNumber()`, `formatNumber.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1943`** (2 nodes): `getBannerMessage()`, `bannerMessage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1944`** (2 nodes): `jsonResponse()`, `checkoutSession.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1945`** (2 nodes): `updateGuest()`, `guest.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1946`** (2 nodes): `getHomepageSnapshot()`, `homepageSnapshot.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1947`** (2 nodes): `posTransaction.test.ts`, `jsonResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1948`** (2 nodes): `storefront.ts`, `getStore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1949`** (2 nodes): `trackingEvents.ts`, `postTrackingEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1950`** (2 nodes): `EntityPage()`, `EntityPage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1951`** (2 nodes): `ProductsPage.tsx`, `ProductCardLoadingSkeleton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1952`** (2 nodes): `AuthComponent()`, `Auth.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1953`** (2 nodes): `toBagSummaryItems()`, `BagSummary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1954`** (2 nodes): `CheckoutForm()`, `CheckoutForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1955`** (2 nodes): `CheckoutProvider()`, `CheckoutProvider.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1956`** (2 nodes): `EnteredBillingAddressDetails()`, `EnteredBillingAddressDetails.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1957`** (2 nodes): `OrderSummary()`, `OrderSummary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1958`** (2 nodes): `PickupDetails()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1959`** (2 nodes): `PaymentMethodSection.tsx`, `PaymentMethodSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1960`** (2 nodes): `PaymentSection.tsx`, `PaymentSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1961`** (2 nodes): `calculateDeliveryFee()`, `deliveryFees.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1962`** (2 nodes): `deriveCheckoutState()`, `deriveCheckoutState.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1963`** (2 nodes): `getIssueMap()`, `checkoutSchemas.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1964`** (2 nodes): `webOrderSchema.test.ts`, `getIssueMap()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1965`** (2 nodes): `onSubmit()`, `CustomerDetailsForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1966`** (2 nodes): `onSubmit()`, `DeliveryDetailsForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1967`** (2 nodes): `useCountdown()`, `hooks.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1968`** (2 nodes): `TrustSignals.tsx`, `TrustSignals()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1969`** (2 nodes): `ProductFilter.tsx`, `ProductFilter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1970`** (2 nodes): `handleCheckboxChange()`, `Filter.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1971`** (2 nodes): `BestSellersSection()`, `BestSellersSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1972`** (2 nodes): `handleOnLinkClick()`, `BagMenu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1973`** (2 nodes): `MobileBagMenu()`, `MobileBagMenu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1974`** (2 nodes): `SiteBanner.tsx`, `SiteBanner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1975`** (2 nodes): `NotificationPill()`, `NotificationPill.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1976`** (2 nodes): `mapValueToLabelIndex()`, `DimensionBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1977`** (2 nodes): `DiscountBadge()`, `DiscountBadge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1978`** (2 nodes): `handleClickOnPreview()`, `GalleryViewer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1979`** (2 nodes): `OnsaleProduct()`, `OnSaleProduct.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1980`** (2 nodes): `ProductActions.tsx`, `ProductActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1981`** (2 nodes): `ProductAttributes.tsx`, `ProductAttributes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1982`** (2 nodes): `ProductPage.test.tsx`, `makePageState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1983`** (2 nodes): `ProductPage.tsx`, `showShippingPolicy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1984`** (2 nodes): `ProductReview.tsx`, `handleHelpful()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1985`** (2 nodes): `ReviewSummary.tsx`, `ReviewSummary()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1986`** (2 nodes): `OrderItem()`, `OrderItem.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1987`** (2 nodes): `RatingSelector.tsx`, `RatingSelector()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1988`** (2 nodes): `GuestRewardsPrompt()`, `GuestRewardsPrompt.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1989`** (2 nodes): `OrderPointsDisplay()`, `OrderPointsDisplay.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1990`** (2 nodes): `PastOrdersRewards.tsx`, `handleClaimPoints()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1991`** (2 nodes): `RewardsPanel.tsx`, `handleRedeemReward()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1992`** (2 nodes): `BagItem()`, `BagItem.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1993`** (2 nodes): `CheckoutUnavailable()`, `CheckoutUnavailable.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1994`** (2 nodes): `ErrorBoundary()`, `ErrorBoundary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1995`** (2 nodes): `ScrollDownButton.tsx`, `ScrollDownButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1996`** (2 nodes): `CountrySelect()`, `country-select.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1997`** (2 nodes): `GhanaRegionSelect()`, `ghana-region-select.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1998`** (2 nodes): `GhostButton()`, `ghost-button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1999`** (2 nodes): `handleClose()`, `LeaveAReviewModal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2000`** (2 nodes): `UpsellModalSuccess.tsx`, `UpsellModalSuccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2001`** (2 nodes): `WelcomeBackModalSuccess.tsx`, `WelcomeBackModalSuccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2002`** (2 nodes): `getModalConfig()`, `leaveReviewModalConfig.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2003`** (2 nodes): `welcomeBackModalConfig.tsx`, `getModalConfig()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2004`** (2 nodes): `webp-jpg.tsx`, `WebpImage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2005`** (2 nodes): `useFormSubmission()`, `FormSubmissionProvider.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2006`** (2 nodes): `StoreContext.characterization.test.tsx`, `Probe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2007`** (2 nodes): `useCheckout.ts`, `useCheckout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2008`** (2 nodes): `useDiscountCodeAlert.tsx`, `useDiscountCodeAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2009`** (2 nodes): `useEnhancedTracking.ts`, `useEnhancedTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2010`** (2 nodes): `useGetActiveCheckoutSession.tsx`, `useGetActiveCheckoutSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2011`** (2 nodes): `useGetProduct.tsx`, `useGetProductQuery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2012`** (2 nodes): `useGetProductFilters.ts`, `useGetProductFilters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2013`** (2 nodes): `useGetProductReviews.ts`, `useGetProductReviewsQuery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2014`** (2 nodes): `useGetStore.ts`, `useGetStore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2015`** (2 nodes): `useInventoryStatus.ts`, `useInventoryStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2016`** (2 nodes): `useLeaveAReviewModal.tsx`, `useLeaveAReviewModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2017`** (2 nodes): `useLogout.ts`, `useLogout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2018`** (2 nodes): `useModalState.tsx`, `useModalState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2019`** (2 nodes): `useProductPageLogic.ts`, `useProductPageLogic()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2020`** (2 nodes): `useProductReminder.tsx`, `useProductReminder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2021`** (2 nodes): `usePromoAlert.tsx`, `usePromoAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2022`** (2 nodes): `useQueryEnabled.ts`, `useQueryEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2023`** (2 nodes): `useRewardsAlert.tsx`, `useRewardsAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2024`** (2 nodes): `useScrollToTop.ts`, `useScrollToTop()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2025`** (2 nodes): `useTrackAction.ts`, `useTrackAction()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2026`** (2 nodes): `useTrackEvent.ts`, `useTrackEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2027`** (2 nodes): `useUpsellModal.tsx`, `useUpsellModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2028`** (2 nodes): `usePostAnalytics()`, `analytics.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2029`** (2 nodes): `useBagQueries()`, `bag.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2030`** (2 nodes): `useBannerMessageQueries()`, `bannerMessage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2031`** (2 nodes): `useCheckoutSessionQueries()`, `checkout.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2032`** (2 nodes): `useHomepageSnapshotQueries()`, `homepageSnapshot.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2033`** (2 nodes): `useInventoryQueries()`, `inventory.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2034`** (2 nodes): `useOnlineOrderQueries()`, `onlineOrder.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2035`** (2 nodes): `posTransaction.ts`, `usePosTransactionQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2036`** (2 nodes): `product.ts`, `useProductQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2037`** (2 nodes): `promoCode.ts`, `usePromoCodesQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2038`** (2 nodes): `reviews.ts`, `useReviewQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2039`** (2 nodes): `rewards.ts`, `useRewardsQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2040`** (2 nodes): `upsells.ts`, `useUpsellsQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2041`** (2 nodes): `user.ts`, `useUserQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2042`** (2 nodes): `userOffers.ts`, `useUserOffersQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2043`** (2 nodes): `storeConfig.test.ts`, `buildV2Config()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2044`** (2 nodes): `storefrontObservability.test.ts`, `createMemoryStorage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2045`** (2 nodes): `validateEmail()`, `email.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2046`** (2 nodes): `App()`, `main.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2047`** (2 nodes): `router.tsx`, `createRouter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2048`** (2 nodes): `loadHomePageData()`, `-homePageLoader.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2049`** (2 nodes): `LayoutComponent()`, `_ordersLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2050`** (2 nodes): `ContactUs()`, `contact-us.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2051`** (2 nodes): `OnlineOrderPolicy()`, `delivery-returns-exchanges.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2052`** (2 nodes): `privacy.index.tsx`, `PrivacyPolicy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2053`** (2 nodes): `tos.index.tsx`, `TosSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2054`** (2 nodes): `shop.product.$productSlug.tsx`, `Component()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2055`** (2 nodes): `LayoutComponent()`, `_layout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2056`** (2 nodes): `HomeRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2057`** (2 nodes): `CheckoutCanceledView()`, `canceled.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2058`** (2 nodes): `CheckoutComplete()`, `complete.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2059`** (2 nodes): `pod-confirmation.tsx`, `completePODCheckoutSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2060`** (2 nodes): `ReceiptShareRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2061`** (2 nodes): `test-connection.js`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2062`** (2 nodes): `run()`, `architecture-boundary-check.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2063`** (2 nodes): `fixture()`, `delivery-diff-fingerprint.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2064`** (2 nodes): `git()`, `delivery-documentation-admission.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2065`** (2 nodes): `invokeAdapter()`, `delivery-emit.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2066`** (2 nodes): `invoke()`, `delivery-live-sensor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
