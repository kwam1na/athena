...
## Summary
- 15034 nodes · 18645 edges · 3311 communities detected
...
5. `collectOperationAdmissionCheckResult()` - 27 edges
6. `applyInventoryEffectWithCtx()` - 22 edges
7. `submitTerminalRuntimeStatus()` - 21 edges
8. `readBuffer()` - 21 edges
9. `collectConvexIngressFromSource()` - 21 edges
10. `buildDailyOpeningSnapshotWithCtx()` - 20 edges

## Surprising Connections (you probably didn't know these)
- `findKernelImportViolations()` --calls--> `importsOf()`  [EXTRACTED]
  packages/athena-webapp/convex/agentHarness/importBoundary.test.ts → packages/athena-webapp/src/components/agent/importBoundary.test.ts
- `findLeafImportViolations()` --calls--> `importsOf()`  [EXTRACTED]
  packages/athena-webapp/convex/agentHarness/importBoundary.test.ts → packages/athena-webapp/src/components/agent/importBoundary.test.ts
- `findRootConvexConfigViolations()` --calls--> `importsOf()`  [EXTRACTED]
  packages/athena-webapp/convex/agentHarness/importBoundary.test.ts → packages/athena-webapp/src/components/agent/importBoundary.test.ts
- `findRegistrationShimViolations()` --calls--> `importsOf()`  [EXTRACTED]
  packages/athena-webapp/convex/agentHarness/importBoundary.test.ts → packages/athena-webapp/src/components/agent/importBoundary.test.ts
- `findIndirectComponentMountViolations()` --calls--> `importsOf()`  [EXTRACTED]
  packages/athena-webapp/convex/agentHarness/importBoundary.test.ts → packages/athena-webapp/src/components/agent/importBoundary.test.ts
...
Cohesion: 0.03
Nodes (86): buildHarnessDocPaths(), buildHarnessDocPathsForArchetype(), assertSelectionCandidate(), captureCanonicalValidationPlan(), jsonRecord(), resolveHostedValidationBinding(), shaValue(), createValidationHealthDigest() (+78 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (92): approvalBelongsToRange(), approvalRequestTypeLabel(), asCarryForwardItem(), buildApprovalRequestsById(), buildCompletedOnlineOrderTotals(), buildDailyCloseExpenseProductEvidence(), buildDailyCloseLifecycleGateWithCtx(), buildDailyCloseReportSnapshot() (+84 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (96): assertCorsAllowlist(), assertRootErrorHandler(), bindingNameTexts(), builderReferenceKind(), buildPartition(), buildRouterExportIndex(), calleeMember(), collectApiSelfCallSites() (+88 more)
...
Cohesion: 0.06
Nodes (90): buildFinding(), buildHumanReport(), buildSemanticPrompt(), buildShadowSummary(), buildShellCommandPattern(), collectConvexQueryWriteBoundaryFindings(), collectConvexReturnValidatorContractFindings(), collectHandlerDbAliases() (+82 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (72): buildInventoryScopedOperationalExplanation(), buildMissingAggregateOperationalExplanation(), buildRecoveryBlockers(), buildRecoveryBlockersFromPreview(), buildRecoveryReadiness(), buildStaticOperationalExplanation(), buildTerminalAppUpdatePresentation(), buildTerminalOperationalExplanationPresentation() (+64 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (69): attentionSeverity(), automationRunClassification(), automationStatusBucketForRun(), buildApprovalsLane(), buildDailyOperationsSnapshotWithCtx(), buildLanes(), buildLiveWeekMetricForDate(), buildPendingRegisterCountTimelineMessage() (+61 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (74): applyImportedSkuInventoryWithCtx(), buildFinalTrustedQuantitiesByRowNumber(), buildProductPageFinalizationMetadata(), buildProductPageFinalizationPayloadHash(), buildProvisionalSkuPatch(), buildSaleEvidenceFingerprint(), buildSkuInsert(), buildSkuPatch() (+66 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (67): applySaleInventoryMovements(), assertNever(), buildSaleProjectedMessage(), calculateSalePayments(), canMapExistingCloudRegisterSession(), canReuseCloudRegisterSessionForLocalOpen(), canSupersedeReviewedRegisterSessionForLocalOpen(), capNonCashPaymentsToExpectedTotal() (+59 more)
...
Cohesion: 0.04
Nodes (35): assertPosLocalStoreOk(), buildRuntimeAppUpdateInput(), claimRuntimeStatusPublishForCycle(), clearAcceptedTerminalIntegrityState(), clearRuntimeStatusSyncingPublishDelay(), collectAcceptedEventIdsWithLocalPrecursors(), collectReviewLocalEventIds(), collectRuntimeRelevantEvents() (+27 more)
...
Cohesion: 0.07
Nodes (49): addDaysToOperatingDate(), asRecord(), automationErrorMessage(), automationIdempotencyKey(), configuredEodAutoCompleteStoreDayContext(), configuredOpeningOperatingDate(), emitHistoricEodDailyManagerReportWithCtx(), eodAutoCompleteDecision() (+41 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (42): appendCompletedPosLifecycleJournal(), applyApprovedTransactionVoid(), buildCompleteTransactionResult(), buildPosPriceOverrideApprovalRequirement(), buildVoidApprovalRequirement(), calculateCanonicalTransactionTotals(), calculateTotalPaid(), completedTransactionLabel() (+34 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (46): addDaysToDate(), addSkuMetrics(), buildDay(), buildModel(), canonicalizeMovementPage(), changeBasisPoints(), composeLiveDay(), composeLiveSkuEntries() (+38 more)
...
Cohesion: 0.11
Nodes (42): applyOccurrenceBinding(), clearPosClientTelemetryBuffer(), clearPrunedRemovalArtifacts(), compareStrings(), compareTelemetryEvents(), decodeBufferedEvent(), decodeLegacyEvent(), decodeOccurrenceBinding() (+34 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (28): buildDisplaySafeConflictSummary(), buildTerminalIdentityHandoffCandidate(), buildTerminalSyncReviewSummary(), classifyTerminalSyncReviewConflict(), dedupeConflictsById(), emptyTerminalSyncReviewSummary(), getConflictBusinessKey(), getCurrentConflictKey() (+20 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (40): approvalMetadataEntries(), approvalRequestTypeLabel(), buildDailyOpeningSnapshotWithCtx(), buildFrozenCarryForwardState(), buildReadiness(), carryForwardItem(), compactMetadataEntries(), formatPaymentMethodLabel() (+32 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (24): accumulatePaymentMixFact(), addPaymentMix(), addPaymentMixAmount(), addPaymentParticipation(), addWeekMetrics(), applyPaymentMixContribution(), combineRevisionPaymentMix(), computeMixRequestKey() (+16 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (23): Boolean(), buildMissingDraftResult(), formatCatalogSetupProductName(), formatOpenWorkHeaderTitle(), formatQueueWorkItemValue(), formatWorkItemTitle(), getOpenWorkMixEntries(), getQueueWorkItemInventoryReviewLineCount() (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (38): asHarnessBehaviorBlocker(), asRegExp(), assertScenarioPortsAvailable(), captureCommandOutput(), collectLatencyDiagnostics(), collectRuntimeSignalDiagnostics(), collectRuntimeSignalMatches(), collectScenarioLocalPorts() (+30 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (32): buildBlockers(), buildCarryForwardItems(), buildCashMetrics(), buildDailyExpensePresentation(), buildDailyManagerReportPayload(), buildDailyTopMoversUrl(), buildOpenDailyManagerReportPayload(), buildPaymentTotals() (+24 more)
...
Cohesion: 0.12
Nodes (35): acceptedInventoryFromClose(), acceptedPeriod(), acceptedTopSkuLeaders(), addDay(), clearWeeklyAcceptanceIntent(), computeWeeklyVariancePosture(), deriveWeeklyAmendment(), firstIncompleteReason() (+27 more)
...
Cohesion: 0.13
Nodes (28): assertStaffProfileReadyForCredential(), authenticateStaffCredentialForApprovalWithCtx(), authenticateStaffCredentialForTerminalWithCtx(), authenticateStaffCredentialWithCtx(), createStaffCredentialAdmittedHandler(), createStaffCredentialWithCtx(), getActiveRolesForStaffProfile(), getCredentialById() (+20 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (29): assertRegisterNumberIsAvailable(), buildRuntimeActiveRegisterSessionDirective(), buildRuntimeDrawerAuthorityDirective(), cleanActiveRegisterSession(), cleanAppSessionRecovery(), cleanAppShell(), cleanAppUpdate(), cleanBrowserInfo() (+21 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (28): buildDependencyGraph(), checkKernelViolations(), collectNonCodeRanges(), collectSources(), escapedReentryIsBackendSurface(), expandAlias(), extractImportSpecifiers(), findNewCycles() (+20 more)
...
Cohesion: 0.14
Nodes (26): admitCapabilityCallWithCtx(), admitRunForWork(), agentRunCapability(), beginProgramAttemptWithCtx(), cancelAgentRunWithCtx(), checkRunEpochFenceWithCtx(), clampCallsWithCtx(), clampRunChildrenWithCtx() (+18 more)

### Community 43 - "Community 43"
Cohesion: 0.2
Nodes (29): addSafeIntegers(), allocateCostParts(), applyExactValuationBasisCorrection(), applyInboundPart(), applyInboundValuation(), applyOutboundValuation(), applyReturnValuation(), applyValuationCorrection() (+21 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (20): cleanMetadataValue(), inclusiveDaySpan(), inventoryAttentionProjection(), lastClosedScheduledDate(), liveWeeklyInventoryAttention(), precedingEqualRange(), priorNetSalesChange(), priorPeriodProjection() (+12 more)
...
Cohesion: 0.09
Nodes (17): cancelItemAdjustmentWorkflow(), exitCorrectionWorkflow(), formatCorrectionEventType(), formatCorrectionHistoryChange(), formatCorrectionHistoryDecision(), formatCorrectionHistoryTitle(), formatCorrectionHistoryTransactionLabel(), formatPaymentMethodLabel() (+9 more)

### Community 49 - "Community 49"
Cohesion: 0.17
Nodes (26): beginPosTerminalIdentityTransition(), capturePosTelemetryOccurrenceContext(), compareIdentityTransitions(), decodeTransition(), dispatchIdentityTransition(), identityPhaseRank(), isNonNegativeFiniteInteger(), isPosTerminalIdentityUncoordinatedQuiescent() (+18 more)
...
Cohesion: 0.15
Nodes (29): accumulatePayment(), addMetrics(), candidateWindow(), closeEvidenceInternallyConsistent(), computeExpectedDay(), diffMetrics(), diffPaymentMix(), diffPaymentPosture() (+21 more)

### Community 53 - "Community 53"
Cohesion: 0.18
Nodes (28): asRecord(), buildPosLocalSyncUploadEvents(), customerInfoFromPayload(), findLaterCompletedSale(), getCompletedSaleItems(), getCompletedServiceLines(), isExpenseLocalSyncEvent(), isSyncablePosLocalEvent() (+20 more)

### Community 54 - "Community 54"
Cohesion: 0.14
Nodes (27): assertCompoundSolutionCheck(), collectAgentDocContents(), collectCompoundSolutionFindings(), collectExistingFiles(), collectMarkdownContents(), collectSolutionDocContents(), collectSolutionFingerprintFindings(), collectSourceLineChanges() (+19 more)
...
Cohesion: 0.18
Nodes (27): averageTransaction(), buildFixtureHistoricalMetric(), buildHistoricalMetric(), buildHistoricalMetrics(), buildHistoricalTimeline(), buildPaymentMix(), buildSelectedMetricPaymentMix(), buildSelectedMetricTopItems() (+19 more)
...
Cohesion: 0.21
Nodes (26): autoResolveSyncedSaleInventoryReviewsForStockAdjustmentWithCtx(), conflictError(), findPostReviewStockUpdateWithCtx(), getOperationAdmissionAthenaUserOrRequireAuth(), idMetadataValue(), inventoryReviewLocalId(), inventoryReviewSourceKind(), inventoryReviewSourceMappingIdentity() (+18 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (18): buildProductSkuSearchProjection(), buildSearchText(), hydrateCanonicalProjection(), isProjectionAssistantVisible(), isRegisterCatalogProjectionIncluded(), normalizeAttributes(), normalizeLookup(), projectionsEqual() (+10 more)

### Community 63 - "Community 63"
Cohesion: 0.18
Nodes (26): applyDeferredDeficitTransition(), applyInventoryEffectWithCtx(), applyLateValuationTransition(), applySkuValuationBasisCompensationWithCtx(), applySkuValuationCorrectionWithCtx(), applyValuationTransition(), assertDeficitTransitionReconciles(), assertInteger() (+18 more)

### Community 64 - "Community 64"
Cohesion: 0.16
Nodes (26): getRegisterCatalogPrice(), getRegisterCatalogProjectionPrice(), isActiveProvisionalImportSkuForStore(), isDraftAllowedInTrustedRegisterCatalog(), isLinkedPendingCheckoutAliasVisible(), isLinkedPendingCheckoutApprovedSkuVisible(), isPendingCheckoutItemVisible(), isTrustedRegisterCatalogProjection() (+18 more)
...
Cohesion: 0.14
Nodes (17): applyCheckoutAvailabilityEffects(), checkAdjustedAvailability(), checkIfItemsHaveChanged(), createCheckoutSessionWithCtx(), createOnlineOrder(), createPatchObject(), createSessionItems(), fetchProductSkus() (+9 more)

### Community 68 - "Community 68"
Cohesion: 0.15
Nodes (20): bounded(), createHarnessBlocker(), createHarnessInternalErrorBlocker(), createHarnessUsageErrorBlocker(), formatHarnessBlockers(), formatHarnessCommand(), formatUnexpectedError(), HarnessBlockedError (+12 more)

### Community 69 - "Community 69"
Cohesion: 0.15
Nodes (21): appendListSection(), buildMarkdownBundle(), collectCoverage(), evaluateGraphifyFreshness(), fileExists(), formatValidationCommand(), getChangedFilesFromGit(), isLocalGeneratedArtifactPath() (+13 more)
...
Cohesion: 0.13
Nodes (14): check(), checkHttp(), convexFixture(), createFixtureRoot(), discover(), flagged(), handler(), module() (+6 more)

### Community 77 - "Community 77"
Cohesion: 0.15
Nodes (22): buildGitProcessEnv(), collectCommandsForChangedFiles(), fileExists(), formatMissingPathPrefixError(), getChangedFilesForHarnessReview(), harnessReviewBlockedBlocker(), hasAnyHarnessDocs(), loadReviewTarget() (+14 more)
...
Cohesion: 0.12
Nodes (12): addBudget(), bindingStepIndex(), evaluateBindingAdvance(), evaluateBudgetReservation(), evaluateTransition(), isBindingStepAtOrBeyond(), isTerminalAttemptStatus(), isTerminalCallStatus() (+4 more)
...
Cohesion: 0.18
Nodes (16): bytes(), CloseEvidenceReadError, itemsDigest(), lifecycle(), lifecycleSignature(), materializeCloseEvidenceWithCtx(), nextGeneration(), nonnegativeInteger() (+8 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (4): closedDay(), legacy(), ownerRoutesFor(), seedStore()

### Community 87 - "Community 87"
Cohesion: 0.11
Nodes (10): AgentContractViolationError, AgentVersionedExtensionError, egressClassRank(), isOneOf(), isOpaqueRef(), looksLikeRawDocumentId(), maxEgressClass(), opaqueRef() (+2 more)

### Community 88 - "Community 88"
Cohesion: 0.18
Nodes (21): apply(), connectObserver(), flush(), hide(), hideDemoElements(), hideDemoText(), isActive(), maskDigits() (+13 more)
...
Cohesion: 0.17
Nodes (20): buildConflict(), buildCtx(), buildExpenseConflict(), buildExpenseCtxSeed(), buildExpenseMapping(), buildExpenseSession(), buildExpenseTransaction(), buildExpenseWorkItem() (+12 more)

### Community 93 - "Community 93"
Cohesion: 0.19
Nodes (18): backpressureLifecycle(), cleanupExpiredRangeSnapshots(), configForKind(), ensureRangeSnapshotCore(), finalizePublication(), jitteredRetryAfterMs(), opaqueCorrelationId(), rangeSnapshotRetryBackoffMs() (+10 more)

### Community 94 - "Community 94"
Cohesion: 0.19
Nodes (20): allocateMinorAmounts(), capExceededOutcome(), closeSnapshotFact(), isAcceptedClose(), loadOnlineOrderLines(), markReseedDirty(), nextWalkPhase(), normalizeCurrency() (+12 more)
...
Cohesion: 0.1
Nodes (2): baseArgs(), shared()

### Community 99 - "Community 99"
Cohesion: 0.14
Nodes (14): assertCostOverlayTransition(), buildCostOverlayCreateRequestFingerprint(), buildCostOverlayDecisionTransition(), classifyCostOverlayRetryableWork(), costOverlayHeartbeat(), costOverlayRowMatchesScope(), getCostOverlaySourceProjectionVersion(), isSelectedDecision() (+6 more)

### Community 100 - "Community 100"
Cohesion: 0.22
Nodes (18): classifyCandidate(), classifyExactVersionedSession(), classifyLegacyVersionedCandidate(), classifyShadowRegisterSession(), classifyVersionedCandidate(), classifyVersionedRegisterSession(), getRegisterLifecycleAuthority(), getRegisterLifecycleAuthorityShadow() (+10 more)

### Community 101 - "Community 101"
Cohesion: 0.17
Nodes (16): bindMappingPendingActivity(), createConvexRegisterSessionActivityRepository(), createRegisterSessionActivityIngestionService(), findMappedCloudId(), groupMappingsByLocalEvent(), hasDisallowedMetadataKey(), hasUnsafeMetadataString(), ingestRegisterSessionActivityWithCtx() (+8 more)
...
Cohesion: 0.14
Nodes (11): allocateMinorAmounts(), appendTransition(), applyOnlineOrderUpdate(), assertOwnedOrder(), buildStorefrontFulfillmentSaleFacts(), buildStorefrontRefundFacts(), buildStorefrontReturnFacts(), getOnlineOrderWithCtx() (+3 more)

### Community 104 - "Community 104"
Cohesion: 0.19
Nodes (12): IssueCollector, namespacePath(), projectFields(), projectManifestForGrant(), publicResultFieldNames(), summarizeCapability(), supportedVerbs(), validateCapabilityManifest() (+4 more)
...
Cohesion: 0.19
Nodes (18): collectConvexReturnValidatorContractFindings(), escapeRegExp(), extractConvexPublicFunctionsWithReturns(), extractReturnsSignature(), fileExists(), findMatchingDefinitionEnd(), findValidatorExpressionEnd(), hasConvexReturnContractProofForExport() (+10 more)
...
Cohesion: 0.14
Nodes (8): capitalizeFirstLetter(), capitalizeWords(), cn(), currencyFormatter(), getErrorForField(), getRelativeTime(), slugToWords(), toSlug()
...
Cohesion: 0.21
Nodes (13): activityEnvelope(), approvalsEnvelope(), attentionEnvelope(), automationEnvelope(), complete(), daySalesEnvelope(), envelope(), positionsEnvelope() (+5 more)

### Community 124 - "Community 124"
Cohesion: 0.12
Nodes (5): executorCtx(), hostFor(), runtime(), seededRefs(), traceRows()
...
Cohesion: 0.22
Nodes (17): assertLandedChangeReportCheck(), collectExistingFiles(), collectLandedChangeReportFindings(), collectReportContents(), collectReportsExistingAtBase(), collectSourceLineChanges(), countFileLines(), extractReportDiffFingerprint() (+9 more)

### Community 128 - "Community 128"
Cohesion: 0.25
Nodes (14): authorityDigestOf(), denied(), deriveAuthorityTier(), enablementRefusal(), encodeDelegatedActorRef(), failed(), loadRunGrantWithCtx(), materializeRunGrantWithCtx() (+6 more)
...
Cohesion: 0.17
Nodes (11): buildLatestRunDebugPayload(), getBoundedDebugRunsByCapability(), getLatestDebugRunByCapability(), getLatestDebugRunBySubject(), isActiveRunStale(), isActiveRunStatus(), isAgentHarnessRun(), selectLatestDebugRunFromCandidates() (+3 more)
...
Cohesion: 0.2
Nodes (15): annotateDateDisplays(), annotateMoneyDisplays(), escapeRegExp(), formatMinorMoney(), formatOperatingDateDisplay(), humanizeToken(), isMoneyValue(), mergeLexicons() (+7 more)

### Community 136 - "Community 136"
Cohesion: 0.16
Nodes (11): canReuseCloudRegisterSessionForLocalOpen(), canSupersedeReviewedRegisterSessionForLocalOpen(), drawerAuthorityMatchesActiveRegisterSession(), getRegisterSessionAuthoritativeCloseBoundary(), getRegisterSessionCloseOccurrenceAt(), getSaleBlockingDrawerAuthority(), isDrawerAuthoritySaleBlocking(), isRegisterSessionConflictBlocking() (+3 more)
...
Cohesion: 0.2
Nodes (15): compareSnapshots(), fileExists(), formatArtifactList(), formatDetailLines(), formatError(), formatHarnessJanitorReport(), parseHarnessJanitorCliArgs(), readUtf8OrNull() (+7 more)

### Community 141 - "Community 141"
Cohesion: 0.16
Nodes (8): deniedArguments(), loadAttemptReplayInputsWithCtx(), normalizedRequestDigest(), normalizeHostCall(), resolveAttemptExposure(), resolveTurnExposure(), storedSourceOf(), terminalRevoked()

### Community 142 - "Community 142"
Cohesion: 0.18
Nodes (11): analyze(), applyDeletions(), children(), collectDeclaredNames(), collectProgramFieldAdvisories(), indexFacade(), isNode(), syntaxIssue() (+3 more)
...
Cohesion: 0.23
Nodes (16): deepFreezeDefinition(), defineCashControlsRead(), defineDailyCloseRead(), defineDailyOperationsRead(), defineInventoryCatalogRead(), defineOnlineOrdersRead(), defineOperation(), defineOperationalWorkRead() (+8 more)

### Community 145 - "Community 145"
Cohesion: 0.18
Nodes (9): buildCtx(), buildFrozenClose(), buildObservedCtx(), createDb(), frozenFinancialCompleteness(), frozenFinancialCompletenessForRange(), frozenFinancialCompletenessWithExpenseOverride(), operatingDateRange() (+1 more)
...
Cohesion: 0.15
Nodes (7): canonicalize(), computeToolFingerprint(), hashCanonical(), isJsonLike(), validatePreExecutedExchange(), validateRuntimeEvent(), validateUsageEvent()
...
Cohesion: 0.18
Nodes (13): clearScopeBackoff(), deferScope(), getScopeKey(), hasExactPosTelemetryOccurrenceWitness(), isPosTelemetryBatchIdentityCurrent(), markScopeFailure(), persistScopeBackoff(), pruneScopeBackoff() (+5 more)
...
Cohesion: 0.27
Nodes (15): admitTurnStartWithCtx(), countActiveAgentRunsForOperatorWithCtx(), estimatePromptTokens(), findActiveTurnOnThreadWithCtx(), isWellFormedUnicode(), loadSpendWindow(), measurePromptBytes(), operatorScopeKey() (+7 more)

### Community 157 - "Community 157"
Cohesion: 0.17
Nodes (8): event(), executor(), executorCtx(), runProgram(), runtime(), seedCommittedTurn(), seedStreamingTurnForTrail(), tokens()
...
Cohesion: 0.2
Nodes (10): bindingDigest(), encodeOffsetCursor(), hexToBytes(), keystream(), mintAgentResourceRef(), pageOf(), resolveAgentOperatingWindowWithCtx(), resolveAgentResourceRef() (+2 more)
...
Cohesion: 0.23
Nodes (14): amountComparison(), buildAcceptedWeeklyManagerReportPayload(), buildAcceptedWeeklyTopItems(), buildWeeklyReportUrl(), buildWeeklyTopMoversUrl(), countedCashVarianceMessage(), coverageLabel(), formatDateRange() (+6 more)
...
Cohesion: 0.3
Nodes (15): applyDelta(), applyRollupDayBatchWithCtx(), assertDate(), assertNow(), assertRevision(), captureRollupInputWithCtx(), configuredRollupEpochs(), contribution() (+7 more)
...
Cohesion: 0.14
Nodes (5): createReviewWithCtx(), getStoreFrontActorById(), ownerActorId(), requireOwnedReview(), ReviewOwnershipError
...
Cohesion: 0.17
Nodes (7): clearDefaultPosLocalStore(), createPosLocalStorageRuntime(), createPosLocalStoreRuntimePort(), getDefaultPosLocalStorageRuntime(), getDefaultPosLocalStore(), notifyDefaultLifecycleListeners(), notifyDefaultTerminalSeedListeners()
...
Cohesion: 0.27
Nodes (15): buildAgentSdkGeneration(), canonicalJson(), formatGenerationIssues(), generateAgentSdkArtifacts(), GENERATED_HEADER(), portVersionIssues(), projectCapabilitySchemas(), readCommittedAgentSdkArtifacts() (+7 more)

### Community 181 - "Community 181"
Cohesion: 0.23
Nodes (12): assertDeliveryRunTelemetryCheck(), collectDeliveryRunTelemetryFindings(), currentCandidate(), deliveryRunTelemetryPath(), evaluateDeliveryRunTelemetryCheck(), matchesCurrentGate(), parseDeliveryRunTelemetry(), readCurrentDeliveryRunExport() (+4 more)

### Community 182 - "Community 182"
Cohesion: 0.18
Nodes (9): assertManifestConformance(), assertProfileConformance(), baselineEnablement(), buildAgentCapabilityRegistry(), compareCompatibility(), computeGrantDigest(), planCompatibilityAdvance(), projectGrant() (+1 more)

### Community 183 - "Community 183"
Cohesion: 0.2
Nodes (8): attemptRuntimeCleanupWithCtx(), backoffForAttempt(), deleteAgentHarnessContentForOrganizationWithCtx(), deleteAgentHarnessContentForStoreWithCtx(), deleteAgentHarnessContentWithCtx(), requestRuntimeCleanupWithCtx(), runRuntimeCleanupBatchWithCtx(), sweepExpiredAgentContentWithCtx()
...
Cohesion: 0.28
Nodes (14): assertApprovalDecisionCanApply(), buildApprovalDecisionRequirement(), buildApprovalDecisionSubject(), consumeApprovalDecisionProofWithCtx(), decideApprovalRequestAsAuthenticatedUserWithCtx(), decideApprovalRequestAsCommandWithCtx(), decideApprovalRequestWithCtx(), getApprovalAdmissionAthenaUserOrRequireAuth() (+6 more)

### Community 187 - "Community 187"
Cohesion: 0.22
Nodes (12): boundedIdentity(), compareContribution(), compareString(), deleteOperationalWorkItemWithInventoryWithCtx(), insertOperationalWorkItemWithInventoryWithCtx(), normalizeInventoryContribution(), patchInventoryRepairWithCtx(), patchOperationalWorkItemWithInventoryWithCtx() (+4 more)

### Community 188 - "Community 188"
Cohesion: 0.23
Nodes (12): buildPaymentAllocation(), correctSameAmountSinglePaymentAllocationWithCtx(), ensurePaymentAllocationReportingWithCtx(), findSameAmountSinglePaymentAllocation(), listPaymentAllocationsForTargetWithCtx(), matchesExistingAllocation(), matchesKeyedAllocation(), paymentAllocationMixDimensions() (+4 more)

### Community 189 - "Community 189"
Cohesion: 0.32
Nodes (13): assertRoleConfiguration(), buildRoleAssignmentDrafts(), buildStaffFullName(), buildStaffProfileResult(), createStaffProfileWithCtx(), ensureLinkedUserAvailable(), getStaffProfileByIdWithCtx(), normalizeOptionalString() (+5 more)

### Community 190 - "Community 190"
Cohesion: 0.29
Nodes (13): constantTimeEquals(), hmacSha256(), hmacSha256Hex(), isUnsignedStorefrontCookieValue(), rotateRight(), sha256(), sha256Hex(), signaturePayload() (+5 more)
...
Cohesion: 0.16
Nodes (5): baseSaleCompletedPayload(), buildSaleCompletedEvent(), collectPublicSyncArgsIssues(), expectPublicSyncArgsToConform(), expectPublicSyncArgsToReject()

### Community 193 - "Community 193"
Cohesion: 0.22
Nodes (11): DayCapExceeded, expireRangeResults(), foldAndReplaceDay(), loadAcceptedClose(), maintainReportsWithCtx(), markDayDirty(), openPolicyForReason(), rangeSnapshotKindConfigs() (+3 more)

### Community 194 - "Community 194"
Cohesion: 0.25
Nodes (13): classifySharedDemoExternalGateway(), declaredCapabilities(), denySharedDemoAction(), deriveSharedDemoGatewayBindings(), deriveSharedDemoRepresentedCapabilities(), deriveSharedDemoRepresentedReadIntents(), describeDefinition(), isSharedDemoOperationCapabilityAllowed() (+5 more)
...
Cohesion: 0.16
Nodes (5): isPlainRecord(), normalizeLocationNumber(), normalizePosDiagnosticSource(), sanitizePosDiagnosticMetadata(), sourceFromPosDiagnosticError()
...
Cohesion: 0.3
Nodes (13): bindInputs(), closure(), configurationInputs(), connect(), dependencies(), paths(), resolveConsumerImpact(), resolveValidationImpact() (+5 more)
...
Cohesion: 0.22
Nodes (10): asOperationAdmissionDenial(), isAdmittedOutcome(), isRailRaisedDenial(), markAsRailDenial(), operationAdmissionDenial(), operationAdmissionDenialData(), operationDenialError(), OperationUnauthenticatedError (+2 more)
...
Cohesion: 0.16
Nodes (3): anchorToBottom(), positionAt(), settleQuestionTop()
...
Cohesion: 0.26
Nodes (10): addDaysToOperatingDate(), getLocalDateFromOperatingDate(), getLocalOperatingDate(), getLocalOperatingDateRange(), getLocalOperatingDateRangeFromSearch(), isResolvableTimezone(), setOperatingTimezoneOverride(), zonedParts() (+2 more)
...
Cohesion: 0.21
Nodes (6): envFor(), guestCookieFromResponse(), issuedGuestId(), mergeRequests(), request(), signIn()

### Community 222 - "Community 222"
Cohesion: 0.19
Nodes (5): adjustSkuAvailabilityForActiveHolds(), calculateTotalInventoryCount(), getProductByIdOrSlugWithCtx(), productHasPendingCheckoutRegisterCatalogDependency(), removeProductAndRefreshCatalog()
...
Cohesion: 0.28
Nodes (10): boundedLimit(), convertCloseoutRecords(), convertPayments(), migratePosAmountTableWithCtx(), needsPesewasConversion(), nextRemaining(), pesewasPatchForRow(), posPage() (+2 more)
...
Cohesion: 0.36
Nodes (12): advanceCounter(), assertDate(), assertTime(), claimReportWorkWithCtx(), completeReportWorkWithCtx(), enqueueReportWork(), failReportWorkWithCtx(), getClaimedReportWorkWithCtx() (+4 more)
...
Cohesion: 0.17
Nodes (3): AnalyticsOwnershipError, createAnalyticsWithCtx(), extractPromoCodeId()

### Community 232 - "Community 232"
Cohesion: 0.19
Nodes (5): buildKernel(), Gates, makeEchoTool(), makeGateTool(), makeOutcomeTool()
...
Cohesion: 0.18
Nodes (3): ConvexAgentAdapterError, preExecutedMessages(), toNativeToolName()

### Community 245 - "Community 245"
Cohesion: 0.29
Nodes (9): cancellationProgram(), crossPackageProgram(), declaredFieldsOf(), killSwitchProgram(), partialOrNoDataProgram(), report(), roleRestrictedProgram(), runDailyOperationsSmoke() (+1 more)
...
Cohesion: 0.27
Nodes (10): buildOperationalEvent(), buildTraceMetadata(), isRecord(), matchesExistingEvent(), metadataDedupeKeysMatch(), normalizeOperationalEventTraceFields(), presentProductOperationalEvent(), recordOperationalEventWithCtx() (+2 more)
...
Cohesion: 0.38
Nodes (11): assertCustomerOwnsRow(), assertCustomerOwnsRowUnlessServerInitiated(), assertCustomerOwnsStore(), assertCustomerOwnsStoreUnlessServerInitiated(), assertGuestMergeGranted(), consumeGuestMergeGrant(), customerOwnerActorId(), denyCustomerOwnership() (+3 more)
...
Cohesion: 0.32
Nodes (11): assertDigest(), callFunction(), commonIssues(), evaluateScenario(), hard(), main(), parseDriveArgs(), parseJson() (+3 more)

### Community 266 - "Community 266"
Cohesion: 0.26
Nodes (8): discoverCurrentDocumentationWaiver(), downloadGitHubArtifact(), evaluateDeliveryDocumentationAdmission(), loadGitHubWorkflowAttestation(), localPullRequest(), processEnv(), readPullRequestEvent(), requestGitHubJson()

### Community 267 - "Community 267"
Cohesion: 0.24
Nodes (5): createConvexAgentContractHarness(), createConvexTestBackend(), registerAgentComponent(), runtimeCtxFor(), ScriptedModelError

### Community 268 - "Community 268"
Cohesion: 0.25
Nodes (6): correlationUserId(), mintScopedToken(), mintThreadToken(), sha256Hex(), summarizePersistedThread(), tokenOf()

### Community 269 - "Community 269"
Cohesion: 0.31
Nodes (9): attemptRefDigest(), citationBindingDigest(), listCitationCandidatesWithCtx(), mintAttemptRef(), mintCitationRef(), parseAttemptRef(), parseCitationRef(), resolveAttemptRefsWithCtx() (+1 more)

### Community 270 - "Community 270"
Cohesion: 0.27
Nodes (6): assertCapabilityEnableable(), evidenceIssues(), extractClaimSupport(), findDisallowedFields(), provenanceOnly(), runCapabilityConformance()

### Community 271 - "Community 271"
Cohesion: 0.29
Nodes (7): assembleTurnPrompt(), contextOf(), fenceUntrustedData(), neutralizeFence(), parseAnswerPayload(), projectThreadHistoryWithCtx(), resolveViewerAuthorityWithCtx()

### Community 272 - "Community 272"
Cohesion: 0.24
Nodes (4): collectStringLeaves(), cutString(), encodedByteLength(), fitTracePayload()

### Community 273 - "Community 273"
Cohesion: 0.25
Nodes (5): getStorefrontActorFromRequest(), getStorefrontClaimFromRequest(), getStorefrontUserFromRequest(), readCatalogAccessTokenHash(), readVerifiedGuestIdFromRequest()

### Community 274 - "Community 274"
Cohesion: 0.4
Nodes (9): findAthenaUserByEmailIndexedWithCtx(), findAthenaUserByEmailWithCtx(), getAuthenticatedAthenaUserWithCtx(), getAuthenticatedUserRecord(), getOperationAdmissionActorUserId(), normalizeAthenaUserEmail(), requireAuthenticatedAthenaUserIndexedWithCtx(), requireAuthenticatedAthenaUserWithCtx() (+1 more)

### Community 275 - "Community 275"
Cohesion: 0.38
Nodes (8): amountPage(), backfillAmountsToPesewasWithCtx(), boundedAmbiguity(), boundedLimit(), classifyRow(), emptyReasonCounts(), specForTable(), verifyAmountsToPesewasWithCtx()
...
Cohesion: 0.44
Nodes (8): addOperatingDays(), adjacentItemsPeriodDate(), dateRangeForItemsPeriod(), dateRangeForOverviewWindow(), isoWeekStart(), operatingDateToUtc(), tableRangeIncludingSelection(), utcToOperatingDate()
...
Cohesion: 0.27
Nodes (7): formatMechanicalCheckFailure(), isMechanicalScript(), main(), matchesTouchedPath(), normalizeRepoPath(), runHarnessMechanicalCheck(), selectMechanicalCommands()

### Community 299 - "Community 299"
Cohesion: 0.33
Nodes (6): convexFixture(), dependencyFiles(), file(), linkedFixture(), registry(), snapshot()
...
Cohesion: 0.33
Nodes (8): admitFullAdmin(), admittingAdapter(), denialContext(), guards(), honoContext(), rail(), railWithEntrypoints(), respondTo()
...
Cohesion: 0.29
Nodes (6): getSharedDemoActorWithCtx(), requireReadySharedDemoStoreCapabilityIfApplicable(), requireSharedDemoActorWithCtx(), requireSharedDemoCapabilityIfApplicable(), requireSharedDemoStoreCapabilityIfApplicable(), SharedDemoActorError
...
Cohesion: 0.38
Nodes (9): asVitestPackage(), describe(), nearestPackageDir(), readManifest(), resolveVitestRunnerDiagnostic(), runsVitest(), setup(), testFileFilter() (+1 more)
...
Cohesion: 0.31
Nodes (5): createCoverageFixture(), createFixtureRepo(), initializeGitHistory(), runGit(), write()

### Community 344 - "Community 344"
Cohesion: 0.33
Nodes (8): commands(), environment(), main(), parse_args(), Install dependencies only in a fresh native validation workspace., SetupArgumentParser, validate_root(), write_wrapper()

### Community 345 - "Community 345"
Cohesion: 0.38
Nodes (9): assertReportPresentation(), checkHeaderMetadata(), checkInPageAnchors(), checkQuiz(), collectReportPresentationFindings(), collectSectionKeys(), findingsFor(), listReportPaths() (+1 more)

### Community 346 - "Community 346"
Cohesion: 0.31
Nodes (4): call(), invoke(), runPort(), shiftsRequest()

### Community 347 - "Community 347"
Cohesion: 0.31
Nodes (4): cancellingExecutor(), directExecutor(), productionExecutor(), runtime()

### Community 348 - "Community 348"
Cohesion: 0.31
Nodes (4): payloadsOf(), run(), seedCompletedAttempt(), states()
...
Cohesion: 0.33
Nodes (6): authorized(), digest(), errorMessage(), isWaiverApprovalUnavailable(), isWaiverConfigurationError(), secureSecretMatches()

### Community 351 - "Community 351"
Cohesion: 0.28
Nodes (4): admittedCustomerActor(), guestMergeErrorResponse(), isCustomerOwnershipDenial(), requireAdmittedCustomerOwner()

### Community 352 - "Community 352"
Cohesion: 0.25
Nodes (2): harness(), harnessThrowing()
...
Cohesion: 0.39
Nodes (7): base64UrlEncode(), generateCatalogAccessTokenValue(), hashCatalogAccessTokenValue(), mintWithCtx(), normalizeCatalogAccessTokenLabel(), requireStoreFullAdminWithCtx(), revokeWithCtx()
...
Cohesion: 0.44
Nodes (7): addSubscriptionCommandWithCtx(), mapSharedDemoFoundationDenial(), mapSubscriptionCommandError(), removeSubscriptionCommandWithCtx(), requireOrganizationFullAdminWithCtx(), requireOwnedSubscriptionRowWithCtx(), setSubscriptionEnabledCommandWithCtx()
...
Cohesion: 0.33
Nodes (5): buildApprovalRequestPendingData(), formatTransactionNumber(), metadataNumber(), metadataString(), resolveApprovalRequestIdentifier()
...
Cohesion: 0.28
Nodes (3): payment(), receipt(), saleFact()

### Community 367 - "Community 367"
Cohesion: 0.42
Nodes (8): addMetric(), applyToOpenDay(), batchTransactionDelta(), factDeltas(), findExistingFact(), findRecordedPosTransactions(), recordFacts(), toFactDoc()

### Community 368 - "Community 368"
Cohesion: 0.44
Nodes (8): applySummaryRangeBatchWithCtx(), cleanupSummaryRangeWithCtx(), continueSummary(), dirtyRange(), dispatchSummaryRangesWithCtx(), ensureSummaryControlWithCtx(), isSummary(), rangeBasis()
...
Cohesion: 0.39
Nodes (7): at(), completePosture(), makeDayResult(), mismatchState(), paymentMismatchState(), unexplainedMismatch(), zeroMetrics()

### Community 371 - "Community 371"
Cohesion: 0.28
Nodes (3): at(), seedTransaction(), seedVerifiableDay()

### Community 372 - "Community 372"
Cohesion: 0.39
Nodes (7): assertTargetFrame(), buildWigclubWeeklyCorrectionCandidate(), readWigclubCorrectionCandidate(), reconstructExpenseEvidenceForClose(), reconstructTopSkuLeaderIdentity(), totalExpenseProductCount(), uniqueByIndex()
...
Cohesion: 0.39
Nodes (5): isRecord(), omitFields(), projectFeaturedCollection(), projectPublicCatalogProduct(), projectPublicCatalogSku()

### Community 376 - "Community 376"
Cohesion: 0.44
Nodes (8): assertDefaultWorkflowTraceAccess(), assertWorkflowTraceAccess(), getRegisterSessionTraceIdentity(), getWorkflowTraceViewByIdWithCtx(), getWorkflowTraceViewByLookupWithCtx(), requireAdminWorkflowTraceAccess(), requireFullAdminOrManagerElevationTraceAccess(), selectWorkflowTraceEventWindow()

### Community 377 - "Community 377"
Cohesion: 0.25
Nodes (2): scanForRawIdentifiers(), validateReadEnvelope()
...
Cohesion: 0.33
Nodes (5): incrementPosRuntimeCounter(), initializePosRuntimeCounter(), publishCounterChange(), resetPosRuntimeCounters(), setPosRuntimeCounter()
...
Cohesion: 0.31
Nodes (6): artifactBlocker(), assertDeliveryRunTelemetryArtifacts(), collectDeliveryRunTelemetryArtifactFindings(), evaluateDeliveryRunTelemetryArtifacts(), parseTelemetryArtifactArgs(), TelemetryArtifactError

### Community 403 - "Community 403"
Cohesion: 0.44
Nodes (8): buildDocumentationWaiverDispatchArgs(), buildDocumentationWaiverRequest(), buildDocumentationWaiverRequestReceipt(), documentationFindingCodes(), ghJson(), main(), parseDocumentationWaiverArgs(), runGh()

### Community 404 - "Community 404"
Cohesion: 0.31
Nodes (5): digest(), fixture(), historicalTrustSource(), run(), source()

### Community 405 - "Community 405"
Cohesion: 0.29
Nodes (2): delegationRecord(), refusalErrorCode()

### Community 406 - "Community 406"
Cohesion: 0.29
Nodes (2): makeExecutor(), runtime()

### Community 407 - "Community 407"
Cohesion: 0.43
Nodes (6): bandOf(), listOrganizationStores(), listStoresHandler(), listTeamsHandler(), newestHeartbeatAt(), regionOf()
...
Cohesion: 0.32
Nodes (4): assertWaiverCandidateMatches(), canonicalWaiverCandidate(), enrollmentTokenDigest(), requireEnrollmentBootstrap()

### Community 411 - "Community 411"
Cohesion: 0.39
Nodes (5): call(), fakeDb(), harness(), request(), tokenRows()

### Community 412 - "Community 412"
Cohesion: 0.39
Nodes (6): harness(), name(), payHarness(), post(), request(), session()
...
Cohesion: 0.46
Nodes (7): belongsToProduct(), conflictGroupKey(), evaluateProductArchivePrecondition(), guardProductArchiveTransition(), productArchiveBlockedResult(), recordProductArchiveDecision(), withinBudget()
...
Cohesion: 0.36
Nodes (4): activeSchedulesOverlap(), toDraft(), toSummary(), upsertStoreScheduleCommandWithCtx()
...
Cohesion: 0.29
Nodes (2): getOperationActorAthenaUserId(), requireOperationActorAthenaUserId()

### Community 420 - "Community 420"
Cohesion: 0.39
Nodes (5): defineIntentRead(), defineRowScopedCatalogRead(), rowStoreScope(), stockReservationRead(), storeScheduleRead()
...
Cohesion: 0.46
Nodes (6): bytes(), same(), storedFrame(), verifyAcceptedBaselinePageWithCtx(), verifyOne(), verifySealedCorrectionWithCtx()
...
Cohesion: 0.36
Nodes (4): flattenForDraft(), parseInertBlocks(), parseInertSpans(), pushText()

### Community 439 - "Community 439"
Cohesion: 0.29
Nodes (2): baseView(), committedView()
...
Cohesion: 0.46
Nodes (6): canRenewSharedDemoSession(), clearSharedDemoRenewalAttempts(), countSharedDemoRenewalAttempts(), readStore(), readStoredAttempts(), recordSharedDemoRenewalAttempt()
...
Cohesion: 0.29
Nodes (2): isCurrentPosPath(), isPosBrowserCaptureEnabledForCurrentLocation()
...
Cohesion: 0.32
Nodes (3): collectDeliverableDiffFingerprint(), gitEnv(), runGit()
...
Cohesion: 0.36
Nodes (5): collectCanonicalValidationRegistry(), collectHarnessRepoValidationSelection(), matchesHarnessRepoValidationPath(), normalizeRepoPath(), sortUniquePaths()

### Community 468 - "Community 468"
Cohesion: 0.5
Nodes (7): collectHarnessTestTargets(), harnessTestsFailedBlocker(), invalidSelection(), parseHarnessTestCliArgs(), runHarnessTest(), selectHarnessTestTargets(), validateSelectedRunnerArgs()

### Community 469 - "Community 469"
Cohesion: 0.46
Nodes (7): bindingOf(), boundValidationDiagnostics(), collectValidationDiagnostics(), diagnostic(), diagnosticsDirectory(), unavailableDiagnostics(), writeValidationDiagnostics()

### Community 470 - "Community 470"
Cohesion: 0.32
Nodes (3): results(), summaryFixture(), verifyFullInventory()

### Community 471 - "Community 471"
Cohesion: 0.38
Nodes (4): getEnvelope(), healthProbe(), listEnvelope(), storesProbe()

### Community 472 - "Community 472"
Cohesion: 0.43
Nodes (4): executor(), executorCtx(), runtime(), seedCompletedRun()

### Community 473 - "Community 473"
Cohesion: 0.43
Nodes (4): executorCtx(), makeExecutor(), runProgram(), runtime()
...
Cohesion: 0.43
Nodes (5): byteLengthOf(), cutString(), fitNarrativeTrail(), loadTurnNarrativeTrailByBindingWithCtx(), writeTurnNarrativeTrailWithCtx()

### Community 476 - "Community 476"
Cohesion: 0.38
Nodes (3): execute(), makeBridge(), runtime()
...
Cohesion: 0.33
Nodes (2): baseSeed(), storefrontVisibleSeed()

### Community 486 - "Community 486"
Cohesion: 0.48
Nodes (5): findActiveScheduleForStoreAt(), findScheduleGoverningOperatingDate(), getStoreScheduleContextForStoreAtWithCtx(), resolveStoreCalendarRangeForDateWithCtx(), resolveStoreOperatingRangeForDateWithCtx()
...
Cohesion: 0.43
Nodes (5): isFiniteOccurrenceTime(), normalizeWireEvent(), projectClientEventForRead(), sanitizeClientEventMetadata(), truncate()
...
Cohesion: 0.52
Nodes (6): fallbackWarning(), getDaySalesHandler(), getStorePulseHandler(), getWeekPerformanceHandler(), pulseTopItems(), saturdayWeekEnd()
...
Cohesion: 0.57
Nodes (6): accountIn(), grantMerge(), mallorySeed(), run(), seedGuests(), seedTwoShoppers()

### Community 515 - "Community 515"
Cohesion: 0.57
Nodes (6): backfillGuestStoreIdWithCtx(), boundedLimit(), guestPage(), needsStore(), resolveGuestStoreId(), verifyGuestStoreIdWithCtx()
...
Cohesion: 0.43
Nodes (4): customerDenied(), readOperationIngressClaim(), resolveStorefrontCustomer(), verifiedClaimGuestId()
...
Cohesion: 0.38
Nodes (4): awardPointsForGuestOrdersWithCtx(), awardPointsForPastOrderWithCtx(), formatPointsLabel(), listPastEligibleOrders()
...
Cohesion: 0.29
Nodes (1): PosClientDiagnosticsQueryBoundary
...
Cohesion: 0.43
Nodes (4): scriptedRun(), streamingRun(), supersededRun(), withdrawnRun()
...
Cohesion: 0.52
Nodes (6): buildFenceInvocation(), evaluateFenceResult(), main(), parseConvexRunOutput(), parseFenceArgs(), runConvex()
...
Cohesion: 0.57
Nodes (5): captureCoverageBinding(), dependencyState(), digest(), sourceMutationState(), toolchainState()
...
Cohesion: 0.6
Nodes (5): baseMovementScenarios(), fixture(), qualificationFile(), reportFollowupScenarios(), reportOnlyScenario()
...
Cohesion: 0.67
Nodes (5): assertCold(), evidence(), readRecord(), retainedFlags(), verifyFinalHostedValidation()

### Community 698 - "Community 698"
Cohesion: 0.6
Nodes (5): coordinator(), runNativeValidation(), validateInput(), verifiedAttempts(), verifyNativeValidation()
...
Cohesion: 0.5
Nodes (2): productDocument(), skuDocument()
...
Cohesion: 0.6
Nodes (3): getPublicActiveBannerMessageWithCtx(), normalizeDisplayText(), presentPublicBannerMessage()
...
Cohesion: 0.5
Nodes (2): asAuthenticatedAthenaUser(), createStoreWithCurrency()
...
Cohesion: 0.5
Nodes (2): expenseRemainder(), rankManagerReportExpenseProducts()
...
Cohesion: 0.7
Nodes (4): orderObsoleteSourceEvents(), preconditionDrift(), resolveTerminalCloudRepair(), selectLatestSafeDuplicateOpenConflict()
...
Cohesion: 0.6
Nodes (3): failDayWorkWithCtx(), matchingMark(), processDayWorkWithCtx()
...
Cohesion: 0.6
Nodes (3): acceptWithCtx(), processWeeklyWorkWithCtx(), resolveWeekDateWithCtx()

### Community 757 - "Community 757"
Cohesion: 0.7
Nodes (3): financialFrameKey(), isInventoryFinancialFrameUnavailable(), readCurrentWeeklyInventoryWithCtx()
...
Cohesion: 0.6
Nodes (3): projectPosition(), readPositionsHandler(), variantLabelOf()

### Community 763 - "Community 763"
Cohesion: 0.6
Nodes (3): byteLengthOf(), fitAssistantCatalogBody(), searchAssistantCatalogWithCtx()
...
Cohesion: 0.7
Nodes (4): buildTraceCommand(), main(), parseTraceExportArgs(), parseTracePage()
...
Cohesion: 0.6
Nodes (3): config(), fixture(), installedFixture()
...
Cohesion: 0.5
Nodes (2): members(), requireMembers()
...
Cohesion: 0.67
Nodes (2): localImports(), reachableFrom()

### Community 838 - "Community 838"
Cohesion: 1.0
Nodes (3): dayEnd(), dayStart(), seedDailyOperationsStore()
...
Cohesion: 0.67
Nodes (2): createQuickJsProgramRuntime(), loadModule()
...
Cohesion: 0.67
Nodes (2): aggregateHarnessScorecard(), percentile()

### Community 847 - "Community 847"
Cohesion: 0.67
Nodes (2): buildRunInput(), seedRun()
...
Cohesion: 0.67
Nodes (2): readReceiptByShareTokenWithCtx(), toPublicReceiptTransaction()
...
Cohesion: 0.67
Nodes (2): presentSnapshotAtRequestTime(), resolveHomepageSnapshotBootstrap()
...
Cohesion: 0.67
Nodes (2): catalogReaderDenied(), resolveCatalogReader()
...
Cohesion: 0.5
Nodes (1): AthenaUnauthenticatedError
...
Cohesion: 0.67
Nodes (2): backfillProductSkuSearchAssistantFieldsWithCtx(), boundedLimit()
...
Cohesion: 0.83
Nodes (3): describeOperationCapability(), isDynamicOperationCapability(), resolveOperationCapabilities()
...
Cohesion: 0.83
Nodes (3): closeStatusOf(), getStoreDayHandler(), readinessOf()
...
Cohesion: 0.83
Nodes (3): dispatchDayWorkWithCtx(), dispatchProjectionWorkWithCtx(), selectPipelineStores()

### Community 932 - "Community 932"
Cohesion: 0.83
Nodes (3): beginPipelineMigrationWithCtx(), readPipelineMigration(), requirePipelineMigrationStore()
...
Cohesion: 0.83
Nodes (3): acceptedRecoveryPage(), closeRecoveryPage(), maintainWeeklyWorkWithCtx()
...
Cohesion: 1.0
Nodes (3): readEpochPeriodPageWithCtx(), readEpochPeriodResultWithCtx(), unavailable()
...
Cohesion: 0.67
Nodes (2): sharedDemoReadDenialError(), sharedDemoReadDenied()
...
Cohesion: 0.67
Nodes (2): getStoreFrontActorById(), verifyCodeWithCtx()
...
Cohesion: 0.67
Nodes (2): listSavedBagItems(), loadSavedBagById()

### Community 957 - "Community 957"
Cohesion: 0.67
Nodes (2): ctxForStore(), grantedGuestCtx()
...
Cohesion: 0.67
Nodes (2): createAgentRuntimeContractFake(), createDeterministicClock()
...
Cohesion: 0.83
Nodes (3): fingerprintOf(), reportsDeliveredWithSolutionDoc(), solutionDocsDeliveredWithReport()
...
Cohesion: 0.83
Nodes (3): parseQuiz(), parseReportDocument(), sanitize()
...
Cohesion: 0.83
Nodes (3): appStylesheet(), mount(), render()

### Community 1048 - "Community 1048"
Cohesion: 0.67
Nodes (2): assertPage(), assertRecordDestination()
...
Cohesion: 0.67
Nodes (2): buildDocsIndex(), safeReadDir()
...
Cohesion: 0.83
Nodes (3): buildSwitchCommand(), main(), parseSwitchArgs()

### Community 1069 - "Community 1069"
Cohesion: 0.67
Nodes (2): baseInput(), withManifests()

### Community 1070 - "Community 1070"
Cohesion: 0.67
Nodes (2): parseExportOptions(), readValue()
...
Cohesion: 1.0
Nodes (3): createDeliveryFixture(), createFixtureRepo(), write()
...
Cohesion: 0.67
Nodes (2): fixtureReader(), readSource()

### Community 1081 - "Community 1081"
Cohesion: 0.67
Nodes (2): fixture(), setup()
...
Cohesion: 0.67
Nodes (2): guardValidationCandidate(), runValidationGuardCli()
...
Cohesion: 1.0
Nodes (2): createProductionConvexAgentRuntimeAdapter(), experimentProviderOptions()
...
Cohesion: 1.0
Nodes (2): createConvexAgentRuntimeCleanupHook(), ensureConvexAgentRuntimeCleanupRegistered()
...
Cohesion: 1.0
Nodes (2): required(), waiverPasskeyConfig()
...
Cohesion: 1.0
Nodes (2): admittedCustomerActorId(), admittedCustomerOwner()
...
Cohesion: 1.0
Nodes (2): isAllowedStorefrontOrigin(), readStorefrontOriginAllowlist()
...
Cohesion: 1.0
Nodes (2): parseStoreAllowlist(), readStoreAllowlist()
...
Cohesion: 1.0
Nodes (2): isPipelineRecoveryPending(), overviewProjectionStatus()
...
Cohesion: 1.0
Nodes (2): formatDate(), OperatingDatePicker()
...
Cohesion: 1.0
Nodes (2): isExpectedPosTelemetryOutcome(), readOutcomeCode()
...
Cohesion: 1.0
Nodes (2): getOrCreateGuestMarker(), mintGuestMarker()
...
Cohesion: 1.0
Nodes (2): createSnippetLinter(), createStorefrontSnippetLinter()
...
Cohesion: 1.0
Nodes (2): installDeliveryProductSigquitHandler(), runDeliveryProduct()
...
Cohesion: 1.0
Nodes (2): runDeliveryCli(), runPrAthenaDeliveryRun()
...
## Knowledge Gaps
- **4 isolated node(s):** `StaleConstructionError`, `FakeMessageChannel`, `HelpRequested`, `Install dependencies only in a fresh native validation workspace.`
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 1437`** (2 nodes): `createProductionConvexAgentCleanupHook()`, `convexAgentCleanupBinding.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1438`** (2 nodes): `codeOf()`, `models.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1439`** (2 nodes): `resolveDefaultLanguageModel()`, `models.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1440`** (2 nodes): `seedProfileRun()`, `deploymentState.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1441`** (2 nodes): `configured()`, `egressPolicy.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1442`** (2 nodes): `starterIntentPrograms.ts`, `starterIntentProgramFor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1443`** (2 nodes): `turns.testSeams.ts`, `seedRecordedTurn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1444`** (2 nodes): `SharedDemoTicket.ts`, `authorizeSharedDemoTicket()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1445`** (2 nodes): `createDb()`, `automationFoundation.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1446`** (2 nodes): `scheduledRunLedger.test.ts`, `createLedgerCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1447`** (2 nodes): `paymentAllocationAttribution.test.ts`, `readProjectFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1448`** (2 nodes): `registerSessions.test.ts`, `getHandler()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1449`** (2 nodes): `stream.ts`, `getCloudflareConfig()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1450`** (2 nodes): `findSharedDemoEvent()`, `eventDefinitions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1451`** (2 nodes): `analyticsRow()`, `historicalStorefrontContextImport.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1452`** (2 nodes): `buildHistoricalStorefrontContextImportReport()`, `historicalStorefrontContextImportReport.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1453`** (2 nodes): `analyticsRow()`, `legacyStorefrontAnalytics.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1454`** (2 nodes): `sharedDemoActivity.test.ts`, `event()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1455`** (2 nodes): `sharedDemoEvents.test.ts`, `activity()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1456`** (2 nodes): `policy.ts`, `assertSupportedCustomerMessagePolicy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1457`** (2 nodes): `repository.test.ts`, `queryResult()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1458`** (2 nodes): `webhookSecurity.test.ts`, `sign()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1459`** (2 nodes): `summaryValueStyleFor()`, `DailyManagerReport.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1460`** (2 nodes): `DailyManagerReportBordered()`, `DailyManagerReportBordered.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1461`** (2 nodes): `DailyManagerReportUnbordered()`, `DailyManagerReportUnbordered.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1462`** (2 nodes): `OrderEmailPreview()`, `OrderEmail.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1463`** (2 nodes): `OrderEmailCanceledPreview()`, `OrderEmailCanceled.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1464`** (2 nodes): `OrderEmailCompletePreview()`, `OrderEmailComplete.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1465`** (2 nodes): `OrderEmailOutForDeliveryPreview()`, `OrderEmailOutForDelivery.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1466`** (2 nodes): `OrderEmailReadyPreview()`, `OrderEmailReady.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1467`** (2 nodes): `OrderEmailReadyDeliveryPreview()`, `OrderEmailReadyDelivery.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1468`** (2 nodes): `RegisterCloseoutMatchReportPreview.tsx`, `RegisterCloseoutMatchReportPreview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1469`** (2 nodes): `RegisterCloseoutVarianceAlertPreview.tsx`, `RegisterCloseoutVarianceAlertPreview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1470`** (2 nodes): `VerificationCode.tsx`, `VerificationCode()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1471`** (2 nodes): `WalkthroughRequestNotification.tsx`, `delinkUntrustedEmailText()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1472`** (2 nodes): `registrationAuthorization.test.ts`, `authenticatedTestUser()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1473`** (2 nodes): `registrationAuthorization.ts`, `required()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1474`** (2 nodes): `resolvePublicBannerMessage()`, `bannerMessage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1475`** (2 nodes): `appendCalls()`, `landingFunnelEvents.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1476`** (2 nodes): `subcategories.ts`, `removeStorefrontHiddenSubcategoryList()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1477`** (2 nodes): `walkthroughRequests.test.ts`, `acceptCalls()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1478`** (2 nodes): `guestSessionsUnavailable()`, `guest.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1479`** (2 nodes): `savedBagItemOwnership.test.ts`, `seed()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1480`** (2 nodes): `storefrontCors.test.ts`, `readRouteFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1481`** (2 nodes): `user.ts`, `customerDenialResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1482`** (2 nodes): `whatsapp.ts`, `mapWebhookStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1483`** (2 nodes): `handleCollectionNotification()`, `mtnMomo.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1484`** (2 nodes): `utils.test.ts`, `claimFor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1485`** (2 nodes): `createFakeStructuredTextProvider()`, `fake.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1486`** (2 nodes): `isExpiredSharedDemoSessionError()`, `athenaUser.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1487`** (2 nodes): `source()`, `athenaUserIdentityWriters.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1488`** (2 nodes): `mapAthenaAuthSyncError()`, `auth.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1489`** (2 nodes): `createCatalogSummaryCtx()`, `catalogSummary.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1490`** (2 nodes): `listColorsWithCtx()`, `colors.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1491`** (2 nodes): `userErrorFromExpenseItemCommandFailure()`, `expenseSessionItems.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1492`** (2 nodes): `createFakeMutationCtx()`, `expenseTransactions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1493`** (2 nodes): `demoCtx()`, `inventoryIdentityAdmission.sharedDemo.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1494`** (2 nodes): `seedOrganization()`, `inventoryIdentityAdmission.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1495`** (2 nodes): `createWorkContext()`, `inventoryImportCostOverlayWork.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1496`** (2 nodes): `posQueryCleanup.test.ts`, `readProjectFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1497`** (2 nodes): `productUtil.ts`, `buildAllProductsCacheKey()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1498`** (2 nodes): `subcategories.ts`, `listSubcategoriesWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1499`** (2 nodes): `context()`, `commerceEffects.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1500`** (2 nodes): `positionRevisions.ts`, `recordInventoryPositionRevisionWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1501`** (2 nodes): `scheduleWork.ts`, `scheduleReportingWorkBestEffort()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1502`** (2 nodes): `context()`, `athenaUserAuth.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1503`** (2 nodes): `commandResultValidator()`, `commandResultValidators.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1504`** (2 nodes): `storeMemberAccess.ts`, `requireStoreMemberAccessWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1505`** (2 nodes): `testIds.ts`, `testId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1506`** (2 nodes): `callLlmProvider()`, `callLlmProvider.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1507`** (2 nodes): `callAnthropic()`, `anthropic.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1508`** (2 nodes): `callOpenAi()`, `openai.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1509`** (2 nodes): `shouldExpireFunnelRecord()`, `landingFunnelRetention.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1510`** (2 nodes): `walkthroughBudgets.ts`, `consumeWalkthroughBudget()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1511`** (2 nodes): `walkthroughRequestNotifications.test.ts`, `insertAttempt()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1512`** (2 nodes): `createCtx()`, `backfillStoreTimezoneAuthority.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1513`** (2 nodes): `readProjectFile()`, `foundation.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1514`** (2 nodes): `sweeper.ts`, `terminalizeOrphanedDelivery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1515`** (2 nodes): `transport.test.ts`, `stubFetch()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1516`** (2 nodes): `transport.ts`, `sendNotificationEmail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1517`** (2 nodes): `createNormalUserDelegatedAuthorityPort()`, `delegatedAuthority.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1518`** (2 nodes): `turnRead()`, `agentHarness_readDefinitions.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1519`** (2 nodes): `pos_readDefinitions.ts`, `terminalProofPosRead()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1520`** (2 nodes): `reports_definitions.ts`, `defineRangeGenerationOperation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1521`** (2 nodes): `reports_readDefinitions.ts`, `defineReportsRead()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1522`** (2 nodes): `declaresProtectedGateway()`, `effects.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1523`** (2 nodes): `readAdapters.test.ts`, `demoCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1524`** (2 nodes): `readDefinitions.test.ts`, `httpRead()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1525`** (2 nodes): `scopes.ts`, `resolveOperationScope()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1526`** (2 nodes): `consumeCommandApprovalProofWithCtx()`, `approvalActions.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1527`** (2 nodes): `createOperationalEventCtx()`, `approvalAuditEvents.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1528`** (2 nodes): `createApprovalProofMutationCtx()`, `approvalProofs.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1529`** (2 nodes): `createApprovalRequestMutationCtx()`, `approvalRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1530`** (2 nodes): `fixture()`, `inventoryContributions.integration.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1531`** (2 nodes): `item()`, `inventoryContributions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1532`** (2 nodes): `createInventoryMovementCtx()`, `inventoryMovements.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1533`** (2 nodes): `workItem()`, `logicalOperationalWork.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1534`** (2 nodes): `managerReportTopItemsFromMix()`, `managerReportTopItems.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1535`** (2 nodes): `fullWindow()`, `owedDailyCloseSweep.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1536`** (2 nodes): `paymentAllocationCallers.test.ts`, `source()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1537`** (2 nodes): `registerCloseoutVarianceEmail.test.ts`, `getHandler()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1538`** (2 nodes): `staffMessages.ts`, `requireStoreMember()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1539`** (2 nodes): `demoPrincipalCtx()`, `operationAdmission.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1540`** (2 nodes): `sharedDemoCanonicalSites.test.ts`, `demoPrincipalCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1541`** (2 nodes): `storefrontOrigins.test.ts`, `withOrigins()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1542`** (2 nodes): `insertClientEvent()`, `clientEventRetention.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1543`** (2 nodes): `createPendingCheckoutCtx()`, `createOrReusePendingCheckoutItem.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1544`** (2 nodes): `quickAddCatalogItem.test.ts`, `createQuickAddCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1545`** (2 nodes): `buildCorrectionOperationalEvent()`, `correctionEvents.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1546`** (2 nodes): `redactSensitiveDiagnosticText()`, `diagnosticRedaction.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1547`** (2 nodes): `mockCorrectionHistoryDb()`, `getTransactions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1548`** (2 nodes): `createRegisterCatalogCtx()`, `listRegisterCatalog.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1549`** (2 nodes): `recordLocalSyncDeadLetter()`, `deadLetter.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1550`** (2 nodes): `projectionPolicies.test.ts`, `saleItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1551`** (2 nodes): `registerCatalogRevision.test.ts`, `createRevisionCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1552`** (2 nodes): `resolveLocalSyncReview.test.ts`, `createFakeRepository()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1553`** (2 nodes): `staffProofValidation.ts`, `validatePosLocalStaffProofWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1554`** (2 nodes): `transactionAdjustmentPlanner.test.ts`, `baseInput()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1555`** (2 nodes): `posLifecycleJournal.test.ts`, `createCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1556`** (2 nodes): `posLifecycleJournal.ts`, `appendPosLifecycleJournalWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1557`** (2 nodes): `getCashierForRegisterState()`, `cashierRepository.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1558`** (2 nodes): `createExpenseSessionCommandRepository()`, `expenseSessionCommandRepository.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1559`** (2 nodes): `readProjectFile()`, `localSyncRepository.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1560`** (2 nodes): `registerLifecycleAuthorityRepository.ts`, `createRegisterLifecycleAuthorityRepository()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1561`** (2 nodes): `registerSessionRepository.test.ts`, `createRegisterSessionQueryCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1562`** (2 nodes): `sessionCommandRepository.test.ts`, `readProjectFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1563`** (2 nodes): `sessionRepository.test.ts`, `buildSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1564`** (2 nodes): `posRuntimeAdapter.ts`, `buildPosRemoteAssistClientPresence()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1565`** (2 nodes): `remoteAssistRepository.ts`, `createRemoteAssistRepository()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1566`** (2 nodes): `buildContext()`, `LiveKitRemoteAssistTransportProvider.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1567`** (2 nodes): `createRemoteAssistTransportProvider()`, `createRemoteAssistTransportProvider.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1568`** (2 nodes): `public.ts`, `toRemoteAssistSessionReturn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1569`** (2 nodes): `transport.ts`, `issueCredential()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1570`** (2 nodes): `context()`, `access.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1571`** (2 nodes): `requireReportsStoreAccess()`, `access.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1572`** (2 nodes): `seams.characterization.test.ts`, `readDay()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1573`** (2 nodes): `fact()`, `fingerprint.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1574`** (2 nodes): `markDirty()`, `marks.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1575`** (2 nodes): `pipelineAcceptedParity.test.ts`, `fixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1576`** (2 nodes): `pipelineControl.ts`, `readPipelineControl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1577`** (2 nodes): `pipelineDispatchRoot.ts`, `dispatchReportPipeline()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1578`** (2 nodes): `pipelineEvidence.test.ts`, `ledgerFixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1579`** (2 nodes): `pipelineMaintenance.ts`, `purgePipelineBatchWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1580`** (2 nodes): `pipelineRange.test.ts`, `advance()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1581`** (2 nodes): `pipelineRetention.test.ts`, `run()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1582`** (2 nodes): `rollupMaintenance.test.ts`, `fixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1583`** (2 nodes): `rollupMaintenance.ts`, `cleanupObsoleteRollupInputBatchWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1584`** (2 nodes): `rollupParity.test.ts`, `fixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1585`** (2 nodes): `rollupPeriodRead.test.ts`, `fixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1586`** (2 nodes): `rollupWorkers.ts`, `applyRollupWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1587`** (2 nodes): `transactionCounts.ts`, `transactionCountFromCloseSummary()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1588`** (2 nodes): `weeklyInventory.test.ts`, `inventoryReview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1589`** (2 nodes): `weeklyInventoryWorker.ts`, `applyInventoryWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1590`** (2 nodes): `weeklyMarks.ts`, `markWeekDirty()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1591`** (2 nodes): `weeklyPeriods.test.ts`, `schedule()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1592`** (2 nodes): `weeklyRepair.test.ts`, `ledgerIdentity()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1593`** (2 nodes): `weeklyRepair.ts`, `repairCurrentWeeklyProjectionWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1594`** (2 nodes): `posLocalSyncContractValidators.ts`, `unionFromValidators()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1595`** (2 nodes): `getSource()`, `moduleWiring.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1596`** (2 nodes): `serviceCaseTracing.test.ts`, `buildServiceCase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1597`** (2 nodes): `contextFor()`, `actor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1598`** (2 nodes): `createSharedDemoDelegatedAuthorityPort()`, `delegatedAuthority.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1599`** (2 nodes): `posStoreReadAccessCoverage.test.ts`, `source()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1600`** (2 nodes): `providerEnforcement.test.ts`, `invoke()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1601`** (2 nodes): `provision.test.ts`, `seedDemoRegisterFoundation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1602`** (2 nodes): `public.ts`, `selectSharedDemoRegisterBootstrapRecords()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1603`** (2 nodes): `readOperationAdapter.test.ts`, `demoCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1604`** (2 nodes): `registerBaseline.test.ts`, `seedStoreWithRegister()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1605`** (2 nodes): `restore.test.ts`, `restoreStateContext()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1606`** (2 nodes): `scheduledRestore.test.ts`, `keyAt()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1607`** (2 nodes): `createStockOpsAccessQueryCtx()`, `access.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1608`** (2 nodes): `requireStoreFullAdminAccess()`, `access.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1609`** (2 nodes): `purchaseOrderTracing.test.ts`, `createWorkflowTraceCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1610`** (2 nodes): `stockState.ts`, `stockStateOf()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1611`** (2 nodes): `requireOwnedBagItem()`, `bagItem.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1612`** (2 nodes): `createQueryCtx()`, `customerBehaviorTimeline.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1613`** (2 nodes): `createAnalyticsEvent()`, `customerObservabilityTimeline.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1614`** (2 nodes): `readProjectFile()`, `helperOrchestration.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1615`** (2 nodes): `createMutationCtx()`, `customerEngagementEvents.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1616`** (2 nodes): `sku()`, `homepageSnapshot.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1617`** (2 nodes): `savedBagItem.ts`, `requireOwnedSavedBagItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1618`** (2 nodes): `storefrontCustomerAdmission.sharedDemo.test.ts`, `demoCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1619`** (2 nodes): `storefrontCustomerAdmission.test.ts`, `seedStore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1620`** (2 nodes): `storefrontObservabilityReport.test.ts`, `createAnalyticsEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1621`** (2 nodes): `supportTicket.ts`, `createSupportTicketWithCtx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1622`** (2 nodes): `syntheticMonitor.ts`, `isSyntheticMonitorOrigin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1623`** (2 nodes): `timeQueryRefactors.test.ts`, `readSource()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1624`** (2 nodes): `userOffers.ts`, `determineOfferEligibility()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1625`** (2 nodes): `createCtx()`, `ensureTimezoneAuthority.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1626`** (2 nodes): `schedule()`, `operatingPeriods.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1627`** (2 nodes): `buildExpenseSessionTraceSeed()`, `expenseSession.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1628`** (2 nodes): `buildOrder()`, `onlineOrder.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1629`** (2 nodes): `buildOrder()`, `orderReturnExchange.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1630`** (2 nodes): `posSession.ts`, `buildPosSessionTraceSeed()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1631`** (2 nodes): `presentation.ts`, `buildWorkflowTraceViewModel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1632`** (2 nodes): `schemaIndexes.test.ts`, `getTableIndexes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1633`** (2 nodes): `resolveScriptArgs()`, `agentRuntimeHarness.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1634`** (2 nodes): `productLexicon.test.ts`, `baseInput()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1635`** (2 nodes): `starterIntentProgram.ts`, `renderStarterIntentProgram()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1636`** (2 nodes): `formatDate()`, `formatDate.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1637`** (2 nodes): `isAthenaIntelligenceCapability()`, `capabilityTypes.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1638`** (2 nodes): `createContextTracker()`, `contextTracking.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1639`** (2 nodes): `posTerminalRegistrationError.ts`, `isPosRegisterNumberConflict()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1640`** (2 nodes): `productDisplayName.ts`, `formatProductDisplayName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1641`** (2 nodes): `reviewReasonFormatter.ts`, `formatStoredReviewReason()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1642`** (2 nodes): `serviceIntake.ts`, `validateServiceIntakeInput()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1643`** (2 nodes): `sharedDemoRegisterError.ts`, `isSharedDemoRegisterUnavailableError()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1644`** (2 nodes): `textCase.ts`, `capitalizeWords()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1645`** (2 nodes): `transactionNumber.ts`, `generateTransactionNumber()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1646`** (2 nodes): `removeConvexAuthCodeParamFromUrl()`, `convexAuthUrl.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1647`** (2 nodes): `Navigation()`, `OrganizationView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1648`** (2 nodes): `Navigation()`, `OrganizationsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1649`** (2 nodes): `PermissionGate.tsx`, `PermissionGate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1650`** (2 nodes): `ProtectedRoute.tsx`, `ProtectedRoute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1651`** (2 nodes): `SettingsView.tsx`, `SettingsView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1652`** (2 nodes): `StoreActions.tsx`, `StoreActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1653`** (2 nodes): `StoreDropdown.tsx`, `StoreDropdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1654`** (2 nodes): `StoreView.tsx`, `Navigation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1655`** (2 nodes): `StoresDropdown.tsx`, `StoresDropdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1656`** (2 nodes): `handlePrint()`, `BarcodeQRViewer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1657`** (2 nodes): `ProcessingFees.tsx`, `ProcessingFeesView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1658`** (2 nodes): `ProductAvailabilityToggleGroup.tsx`, `ProductAvailabilityToggleGroup()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1659`** (2 nodes): `ProductDetails.tsx`, `handleNameChange()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1660`** (2 nodes): `ProductImages.tsx`, `Header()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1661`** (2 nodes): `ProductPage.tsx`, `ProductPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1662`** (2 nodes): `buildCopyImagesSkuUpdate()`, `CopyImagesView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1663`** (2 nodes): `product-variant-columns.tsx`, `setSourceVariant()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1664`** (2 nodes): `taxonomySelectLabels.ts`, `formatTaxonomySelectOptionLabel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1665`** (2 nodes): `capitalizeFirstLetter()`, `ActivityTimeline.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1666`** (2 nodes): `AnalyticsCombinedUsers()`, `AnalyticsCombinedUsers.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1667`** (2 nodes): `AnalyticsItems()`, `AnalyticsItems.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1668`** (2 nodes): `AnalyticsProducts()`, `AnalyticsProducts.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1669`** (2 nodes): `AnalyticsUsers()`, `AnalyticsUsers.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1670`** (2 nodes): `getDateRangeMilliseconds()`, `EnhancedAnalyticsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1671`** (2 nodes): `StoreInsights.test.tsx`, `renderWithQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1672`** (2 nodes): `VisitorChart.tsx`, `formatHour()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1673`** (2 nodes): `readSource()`, `analyticsWorkspaceEfficiency.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1674`** (2 nodes): `LogItems()`, `LogItems.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1675`** (2 nodes): `Header()`, `LogView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1676`** (2 nodes): `Navigation()`, `LogsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1677`** (2 nodes): `useLoadLogItems.ts`, `useLoadLogItems()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1678`** (2 nodes): `cn()`, `AppMessageHost.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1679`** (2 nodes): `Auth()`, `Auth.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1680`** (2 nodes): `expiredDemoError()`, `DefaultCatchBoundary.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1681`** (2 nodes): `resolveSignIn()`, `InputOTP.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1682`** (2 nodes): `isEmailNotApprovedError()`, `LoginForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1683`** (2 nodes): `expectPendingAuthSyncRedirect()`, `index.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1684`** (2 nodes): `DataTableColumnHeader()`, `data-table-column-header.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1685`** (2 nodes): `handleLoadProducts()`, `BulkOperationsFilters.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1686`** (2 nodes): `makeRow()`, `BulkOperationsPreview.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1687`** (2 nodes): `formatPrice()`, `BulkOperationsPreview.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1688`** (2 nodes): `formatReviewReason()`, `formatReviewReason.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1689`** (2 nodes): `registerSessionColumns.tsx`, `RegisterSessionLink()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1690`** (2 nodes): `CheckoutSessionsTable()`, `CheckoutSessionsTable.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1691`** (2 nodes): `Navigation()`, `CheckoutSesssionsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1692`** (2 nodes): `AnimatedDataState()`, `AnimatedDataState.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1693`** (2 nodes): `AnimatedHeight()`, `AnimatedHeight.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1694`** (2 nodes): `FinancialValue()`, `FinancialValue.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1695`** (2 nodes): `animatedProperties()`, `FlipNumber.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1696`** (2 nodes): `PeriodNavigation.tsx`, `PeriodNavigation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1697`** (2 nodes): `RegisterSessionIdentity.tsx`, `RegisterSessionIdentity()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1698`** (2 nodes): `DocsMarkdown()`, `DocsMarkdown.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1699`** (2 nodes): `answer()`, `DocsReportQuiz.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1700`** (2 nodes): `reset()`, `DocsReportQuiz.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1701`** (2 nodes): `DocsTexture()`, `DocsTexture.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1702`** (2 nodes): `ExpenseView()`, `ExpenseView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1703`** (2 nodes): `BestSellersDialog()`, `BestSellersDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1704`** (2 nodes): `FeaturedSectionDialog()`, `FeaturedSectionDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1705`** (2 nodes): `handleUpdateConfig()`, `LandingPageReelVersion.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1706`** (2 nodes): `ShopLookDialog.tsx`, `ShopLookDialog()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1707`** (2 nodes): `ReadoutSupport.tsx`, `ReadoutTrustMetadata()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1708`** (2 nodes): `JoinTeam()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1709`** (2 nodes): `LandingGrain()`, `LandingGrain.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1710`** (2 nodes): `AutomationRevealScene()`, `AutomationRevealScene.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1711`** (2 nodes): `CashControlsScene()`, `CashControlsScene.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1712`** (2 nodes): `LandingWorkspaceVideo()`, `LandingWorkspaceVideo.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1713`** (2 nodes): `PosHubRoleSwitcher.tsx`, `PosHubRoleSwitcher()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1714`** (2 nodes): `SyncBridgeScene.tsx`, `SyncBridgeScene()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1715`** (2 nodes): `formatDemoMoney()`, `demoDay.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1716`** (2 nodes): `storyTime()`, `demoDayFixtures.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1717`** (2 nodes): `useLandingTheme.ts`, `useLandingTheme()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1718`** (2 nodes): `renderWorkspace()`, `InventoryCostOverlayView.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1719`** (2 nodes): `OperationReviewItemCard()`, `OperationReviewItemCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1720`** (2 nodes): `buildParams()`, `OperationsSummaryMetric.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1721`** (2 nodes): `toApprovalRequesterBindingArg()`, `approvalRequesterBinding.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1722`** (2 nodes): `sourceRef()`, `dailyOperationsAgentPresentation.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1723`** (2 nodes): `handleSendOrderEmail()`, `EmailStatusView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1724`** (2 nodes): `verifiedOrder()`, `OrderDetailsView.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1725`** (2 nodes): `handleTimeRangeChange()`, `OrderMetricsPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1726`** (2 nodes): `Orders()`, `Orders.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1727`** (2 nodes): `OrdersView()`, `OrdersView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1728`** (2 nodes): `RefundsView.tsx`, `handleRefundOrder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1729`** (2 nodes): `useGetActiveOnlineOrder.ts`, `useGetActiveOnlineOrder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1730`** (2 nodes): `OrderCustomerCell()`, `OrderCustomerCell.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1731`** (2 nodes): `handleClearFilters()`, `data-table-toolbar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1732`** (2 nodes): `if()`, `orderColumns.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1733`** (2 nodes): `OrganizationSwitcher()`, `organization-switcher.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1734`** (2 nodes): `buildServiceLine()`, `CartItems.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1735`** (2 nodes): `DebugProducts()`, `DebugProducts.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1736`** (2 nodes): `NoResultsMessage()`, `NoResultsMessage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1737`** (2 nodes): `PinInput.tsx`, `PinInput()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1738`** (2 nodes): `PrintInstructions.tsx`, `PrintInstructions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1739`** (2 nodes): `SearchResultsSection.test.tsx`, `buildProduct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1740`** (2 nodes): `SessionDemo.tsx`, `SessionDemo()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1741`** (2 nodes): `handlePrintReceipt()`, `ExpenseReportView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1742`** (2 nodes): `toExpenseReportRows()`, `expenseReportRows.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1743`** (2 nodes): `buildCheckout()`, `ExpenseCompletionPanel.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1744`** (2 nodes): `POSRegisterView.test.tsx`, `pressDebugPanelShortcut()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1745`** (2 nodes): `RegisterCheckoutPanel.tsx`, `RegisterCheckoutPanel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1746`** (2 nodes): `RegisterCustomerAttribution.test.tsx`, `makeCustomer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1747`** (2 nodes): `RegisterCustomerPanel.tsx`, `RegisterCustomerPanel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1748`** (2 nodes): `RegisterDrawerGate.test.tsx`, `renderGate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1749`** (2 nodes): `RegisterDrawerGate.tsx`, `if()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1750`** (2 nodes): `RegisterSessionPanel.tsx`, `RegisterSessionPanel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1751`** (2 nodes): `POSSalesPulseView.tsx`, `POSStorePulseSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1752`** (2 nodes): `POSTerminalHealthView.tsx`, `CountMetric()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1753`** (2 nodes): `PosClientErrorsPanel.test.tsx`, `buildEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1754`** (2 nodes): `transactionColumns.test.tsx`, `renderTransactionCell()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1755`** (2 nodes): `transactionColumns.tsx`, `getPaymentMethodIcon()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1756`** (2 nodes): `BarcodeView()`, `BarcodeView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1757`** (2 nodes): `CategorizationView()`, `CategorizationView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1758`** (2 nodes): `handleKeyDown()`, `ImagesView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1759`** (2 nodes): `ProductDetailView.tsx`, `ProductDetailViewHeader()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1760`** (2 nodes): `ProductOperationalTimeline.tsx`, `formatEventType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1761`** (2 nodes): `ProductStatus.tsx`, `ProductStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1762`** (2 nodes): `productStockPresentation.ts`, `productStockTextClass()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1763`** (2 nodes): `product-actions.tsx`, `useArchiveProduct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1764`** (2 nodes): `ArchivedProductsToolbar()`, `ArchivedProducts.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1765`** (2 nodes): `CategoryListView()`, `CategoryListView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1766`** (2 nodes): `ProductsView.tsx`, `ProductsView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1767`** (2 nodes): `ProductTaxonomyCells.tsx`, `ProductCategoryCell()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1768`** (2 nodes): `AddProductCommand()`, `add-product-command.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1769`** (2 nodes): `Products.tsx`, `Products()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1770`** (2 nodes): `PromoCodeForm.tsx`, `toggleDiscountType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1771`** (2 nodes): `PromoCodeHeader.tsx`, `handleDeletePromoCode()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1772`** (2 nodes): `PromoCodePreview.tsx`, `Discount()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1773`** (2 nodes): `PromoCodesView.test.tsx`, `readSource()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1774`** (2 nodes): `PromoCodesView.tsx`, `PromoCodesView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1775`** (2 nodes): `SelectableCategories.tsx`, `toggle()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1776`** (2 nodes): `DiscountTypeToggleGroup()`, `DiscountTypeToggleGroup.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1777`** (2 nodes): `PromoCodeSpanToggleGroup.tsx`, `PromoCodeSpanToggleGroup()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1778`** (2 nodes): `CapturedEmails()`, `CapturedEmails.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1779`** (2 nodes): `promo-code-modal.tsx`, `PromoCodeModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1780`** (2 nodes): `RemoteAssistLiveViewer.tsx`, `async()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1781`** (2 nodes): `RemoteAssistRuntimeShell.tsx`, `handleDisconnect()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1782`** (2 nodes): `ReportBackLink.tsx`, `ReportBackLink()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1783`** (2 nodes): `ReportMetricComparisonCrossfade.tsx`, `ReportMetricComparisonCrossfade()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1784`** (2 nodes): `ReportTrendChart.test.tsx`, `labelFormatter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1785`** (2 nodes): `ReportTrustStrip.tsx`, `ReportTrustStrip()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1786`** (2 nodes): `ReportsCatalogLookup.test.tsx`, `result()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1787`** (2 nodes): `ReportsItemsTable.tsx`, `ReportsItemsTable()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1788`** (2 nodes): `ReportsItemsView.test.tsx`, `isoDateOffset()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1789`** (2 nodes): `ReportsItemsView.tsx`, `handlePageChange()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1790`** (2 nodes): `ReportsLayout.test.tsx`, `search()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1791`** (2 nodes): `ReportsLayout.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1792`** (2 nodes): `ReportsSkuDetailView.test.tsx`, `isoDateOffset()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1793`** (2 nodes): `ReportsSkuDetailView.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1794`** (2 nodes): `useStableReportQuery.ts`, `useStableReportQuery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1795`** (2 nodes): `ReviewActions.tsx`, `ReviewActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1796`** (2 nodes): `ServiceCasesView.test.tsx`, `chooseSelectOption()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1797`** (2 nodes): `ServiceCatalogView.test.tsx`, `chooseSelectOption()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1798`** (2 nodes): `ServiceIntakeView.auth.test.tsx`, `chooseSelectOption()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1799`** (2 nodes): `ServiceWorkspaceDemoNotice.tsx`, `ServiceWorkspaceDemoNotice()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1800`** (2 nodes): `ServicesWorkspaceView.test.tsx`, `chooseSelectOption()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1801`** (2 nodes): `DemoNotice()`, `DemoNotice.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1802`** (2 nodes): `SharedDemoManagerSignInGuidance.tsx`, `SharedDemoManagerSignInGuidance()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1803`** (2 nodes): `SharedDemoOwnerHome.tsx`, `SharedDemoOwnerHome()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1804`** (2 nodes): `SharedDemoRestrictedSurface.tsx`, `SharedDemoRestrictedSurface()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1805`** (2 nodes): `SharedDemoRuntime.test.tsx`, `ProviderStatusProbe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1806`** (2 nodes): `SharedDemoSessionRenewal.tsx`, `SharedDemoSessionRenewal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1807`** (2 nodes): `SharedDemoStatusBar.tsx`, `normalizePathname()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1808`** (2 nodes): `sharedDemoActivityTracking.test.ts`, `storage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1809`** (2 nodes): `sharedDemoProviderStatus.ts`, `resolveSharedDemoProvidedBootstrapStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1810`** (2 nodes): `sharedDemoRestoreOverlayModel.ts`, `resolveSharedDemoRestoreOverlayPhase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1811`** (2 nodes): `sharedDemoRestrictions.ts`, `isSharedDemoRestrictedPath()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1812`** (2 nodes): `sharedDemoRoutes.ts`, `getSharedDemoRoutes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1813`** (2 nodes): `sharedDemoRuntimeCoordinator.test.ts`, `deferred()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1814`** (2 nodes): `sharedDemoStockNavigation.ts`, `resolveSharedDemoStockSearch()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1815`** (2 nodes): `StaffMessagesView.tsx`, `submit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1816`** (2 nodes): `staffPinPolicy.ts`, `normalizeStaffPin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1817`** (2 nodes): `onClick()`, `empty-state.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1818`** (2 nodes): `NoPermission()`, `NoPermission.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1819`** (2 nodes): `NoPermissionView()`, `NoPermissionView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1820`** (2 nodes): `NotFoundView()`, `NotFoundView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1821`** (2 nodes): `ProtectedAdminSignInView.tsx`, `ProtectedAdminSignInView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1822`** (2 nodes): `ContactView()`, `ContactView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1823`** (2 nodes): `Header()`, `Header.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1824`** (2 nodes): `MaintenanceView()`, `MaintenanceView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1825`** (2 nodes): `async()`, `NotificationsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1826`** (2 nodes): `StoreHoursView.test.tsx`, `changeAnchorAndSave()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1827`** (2 nodes): `TaxView.tsx`, `handleUpdateTaxSettings()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1828`** (2 nodes): `useNotificationSubscriptions.test.tsx`, `emptyList()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1829`** (2 nodes): `useStoreConfigUpdate.ts`, `useStoreConfigUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1830`** (2 nodes): `useStoreScheduleUpdate.ts`, `useStoreScheduleUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1831`** (2 nodes): `store-switcher.tsx`, `onStoreSelect()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1832`** (2 nodes): `useChart()`, `chart.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1833`** (2 nodes): `handleCopy()`, `copy-button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1834`** (2 nodes): `handleCopy()`, `copy-wrapper.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1835`** (2 nodes): `Label()`, `label.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1836`** (2 nodes): `CustomModal()`, `custom-modal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1837`** (2 nodes): `onSubmit()`, `organization-modal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1838`** (2 nodes): `store-modal.tsx`, `onSubmit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1839`** (2 nodes): `welcome-back-modal-example.tsx`, `WelcomeBackModalExample()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1840`** (2 nodes): `welcome-back-modal.tsx`, `WelcomeBackModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1841`** (2 nodes): `relative-timestamp.test.tsx`, `freezeClock()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1842`** (2 nodes): `relative-timestamp.tsx`, `RelativeTimestamp()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1843`** (2 nodes): `select-native.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1844`** (2 nodes): `sidebar.test.tsx`, `SidebarToggleProbe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1845`** (2 nodes): `timeline-item.tsx`, `TimelineItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1846`** (2 nodes): `webp-image.tsx`, `WebpImage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1847`** (2 nodes): `BagItems()`, `BagItems.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1848`** (2 nodes): `BagItemsView()`, `BagItemsView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1849`** (2 nodes): `Bags()`, `Bags.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1850`** (2 nodes): `String()`, `CustomerBehaviorTimeline.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1851`** (2 nodes): `UserAnalyticsName.tsx`, `UserAnalyticsName()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1852`** (2 nodes): `UserBag.tsx`, `UserBag()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1853`** (2 nodes): `UserInsightsSection.test.tsx`, `renderWithQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1854`** (2 nodes): `UserOnlineOrders.tsx`, `UserOnlineOrders()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1855`** (2 nodes): `UserStatus.tsx`, `UserStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1856`** (2 nodes): `UserView.tsx`, `UserActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1857`** (2 nodes): `CustomerJourneyStageCard()`, `CustomerJourneyStage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1858`** (2 nodes): `UserBehaviorInsights.tsx`, `UserBehaviorInsights()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1859`** (2 nodes): `buildAthenaWebappContextEvent()`, `athenaWebappContextEvents.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1860`** (2 nodes): `useDocsWorkspaceTracking.ts`, `useDocsWorkspaceTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1861`** (2 nodes): `wrapper()`, `ManagerElevationContext.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1862`** (2 nodes): `SessionOrderProbe()`, `OnlineOrderContext.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1863`** (2 nodes): `ProductContext.test.tsx`, `buildProductSku()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1864`** (2 nodes): `screenRedactExtension.test.ts`, `runScreenRedactExtension()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1865`** (2 nodes): `use-image-upload.ts`, `useImageUpload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1866`** (2 nodes): `use-mobile.tsx`, `useIsMobile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1867`** (2 nodes): `use-navigate-back.ts`, `useNavigateBack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1868`** (2 nodes): `use-navigation-keyboard-shortcuts.ts`, `useNavigationKeyboardShortcuts()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1869`** (2 nodes): `use-pagination-persistence.ts`, `usePaginationPersistence()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1870`** (2 nodes): `use-table-keyboard-pagination.ts`, `useTableKeyboardPagination()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1871`** (2 nodes): `useBulkOperations.test.ts`, `makeSku()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1872`** (2 nodes): `useConvexAuthIdentity.ts`, `useConvexAuthIdentity()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1873`** (2 nodes): `useCopyText.ts`, `useCopyText()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1874`** (2 nodes): `useCreateComplimentaryProduct.ts`, `useCreateComplimentaryProduct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1875`** (2 nodes): `useDebounce.ts`, `useDebounce()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1876`** (2 nodes): `useGetActiveProduct.ts`, `useGetActiveProduct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1877`** (2 nodes): `useGetAuthedUser.ts`, `useGetAuthedUser()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1878`** (2 nodes): `useGetCategories.ts`, `useGetCategories()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1879`** (2 nodes): `useGetComplimentaryProducts.ts`, `useGetComplimentaryProducts()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1880`** (2 nodes): `useGetCurrencyFormatter.ts`, `useGetCurrencyFormatter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1881`** (2 nodes): `useGetSubcategories.ts`, `useGetSubcategories()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1882`** (2 nodes): `useGetTerminal.ts`, `useGetTerminal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1883`** (2 nodes): `useNewOrderNotification.ts`, `useNewOrderNotification()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1884`** (2 nodes): `usePermissions.ts`, `usePermissions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1885`** (2 nodes): `useProductSearchResults.ts`, `useProductSearchResults()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1886`** (2 nodes): `useProductWithNoImagesNotification.tsx`, `useProductWithNoImagesNotification()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1887`** (2 nodes): `useProtectedAdminPageState.ts`, `useProtectedAdminPageState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1888`** (2 nodes): `useSheetReturnPosition.ts`, `useSheetReturnPosition()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1889`** (2 nodes): `useSkusReservedInCheckout.ts`, `useSkusReservedInCheckout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1890`** (2 nodes): `useSkusReservedInPosSession.ts`, `useSkusReservedInPosSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1891`** (2 nodes): `useToggleComplimentaryProductActive.ts`, `useToggleComplimentaryProductActive()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1892`** (2 nodes): `useAppActionBlocker.test.tsx`, `wrapper()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1893`** (2 nodes): `UpdateCoordinatorProvider.tsx`, `UpdateCoordinatorProvider()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1894`** (2 nodes): `createFakeWindow()`, `appUpdateReload.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1895`** (2 nodes): `updateAssetStaging.test.ts`, `FakeMessageChannel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1896`** (2 nodes): `updateCommunicationPreference.tsx`, `UpdateCommunicationPreferenceProvider()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1897`** (2 nodes): `updateDetectionSequencer.test.ts`, `createDeferredStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1898`** (2 nodes): `updateDetectionSequencer.ts`, `createUpdateDetectionSequencer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1899`** (2 nodes): `useUpdateApplyBlocker.ts`, `useUpdateApplyBlocker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1900`** (2 nodes): `toOperatorMessage()`, `operatorMessages.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1901`** (2 nodes): `presentUnexpectedErrorToast.ts`, `presentUnexpectedErrorToast()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1902`** (2 nodes): `sharedDemoDenialObserver.test.ts`, `demoDenial()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1903`** (2 nodes): `storeEntryRoute.ts`, `getStoreEntryRouteForRole()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1904`** (2 nodes): `posLocalStoreTypes.ts`, `canUploadPosLocalEventType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1905`** (2 nodes): `addItem()`, `addItem.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1906`** (2 nodes): `bootstrapRegister()`, `bootstrapRegister.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1907`** (2 nodes): `holdSession()`, `holdSession.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1908`** (2 nodes): `openDrawer()`, `openDrawer.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1909`** (2 nodes): `startSession.ts`, `startSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1910`** (2 nodes): `calculateCartTotals()`, `calculations.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1911`** (2 nodes): `scope()`, `expenseLocalCommandGateway.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1912`** (2 nodes): `posLocalLedgerPolicy.ts`, `assessPosLocalLedgerRetention()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1913`** (2 nodes): `posLocalStorageBoundary.test.ts`, `collectProductionSources()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1914`** (2 nodes): `posLocalStorageRuntimeContext.test.tsx`, `RuntimeStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1915`** (2 nodes): `posLocalStoreErrorTaxonomy.test.ts`, `failingAdapter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1916`** (2 nodes): `posLocalStoreMigrationCoordinator.test.ts`, `createLogicalFixtureEngine()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1917`** (2 nodes): `posLocalStoreMigrationCoordinator.ts`, `createTestOnlyPosLocalStoreMigrationCoordinator()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1918`** (2 nodes): `posLocalStoreMigrations.ts`, `runPosLocalStoreMigrations()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1919`** (2 nodes): `posLocalStoreSnapshot.ts`, `validatePosLocalStoreSnapshotShape()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1920`** (2 nodes): `posLocalStoreVersions.ts`, `comparePosLocalStoreVersion()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1921`** (2 nodes): `registerAvailabilitySnapshot.test.ts`, `buildAvailabilityRow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1922`** (2 nodes): `registerAvailabilitySnapshot.ts`, `readRegisterAvailabilitySnapshotState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1923`** (2 nodes): `registerLifecycleAuthorityReconciliation.test.ts`, `versioned()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1924`** (2 nodes): `registerServiceCatalogSnapshot.test.ts`, `buildServiceCatalogRow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1925`** (2 nodes): `registerServiceCatalogSnapshot.ts`, `readRegisterServiceCatalogSnapshotState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1926`** (2 nodes): `registerSessionAuthorityBootstrap.ts`, `seedRegisterSessionAuthorityBootstrap()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1927`** (2 nodes): `syncGapDiagnosis.ts`, `diagnoseHeldSyncBlocker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1928`** (2 nodes): `syncScheduler.test.ts`, `baseEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1929`** (2 nodes): `syncStatus.test.ts`, `event()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1930`** (2 nodes): `terminalRuntimeStatus.test.ts`, `buildLocalEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1931`** (2 nodes): `terminalStaffAuthorityRefresh.test.ts`, `buildAuthorityRecord()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1932`** (2 nodes): `uploadPageDiagnostics.test.ts`, `fixture()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1933`** (2 nodes): `uploadPageDiagnostics.ts`, `collectUploadPageDiagnostics()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1934`** (2 nodes): `reportPosHandledException()`, `loggerGateway.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1935`** (2 nodes): `telemetryContext.test.ts`, `listener()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1936`** (2 nodes): `useRegisterCatalogIndex.ts`, `useRegisterCatalogIndex()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1937`** (2 nodes): `useRegisterCheckoutDraftState.ts`, `useRegisterCheckoutDraftState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1938`** (2 nodes): `useRegisterLocalRuntime.test.ts`, `renderRuntime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1939`** (2 nodes): `registerSessionCode.ts`, `formatRegisterSessionCode()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1940`** (2 nodes): `remoteAssistCobrowseRecorder.test.ts`, `setElementRect()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1941`** (2 nodes): `runtime.test.ts`, `buildState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1942`** (2 nodes): `runtime.ts`, `getRemoteAssistConnectedState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1943`** (2 nodes): `useRemoteAssistSupportTransport.ts`, `useRemoteAssistSupportTransport()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1944`** (2 nodes): `RemoteAssistLiveTransportClient.test.ts`, `encode()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1945`** (2 nodes): `pinHash.ts`, `hashPin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1946`** (2 nodes): `productSkuSearchAdapters.test.ts`, `buildResult()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1947`** (2 nodes): `theme.test.ts`, `installMatchMedia()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1948`** (2 nodes): `AuthenticatedLayout()`, `-authenticated-layout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1949`** (2 nodes): `getSharedDemoEntryPresentation()`, `-demo-presentation.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1950`** (2 nodes): `-public-layout.tsx`, `onScroll()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1951`** (2 nodes): `waiver-passkey.tsx`, `enroll()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1952`** (2 nodes): `hasOrgNotFoundPayload()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1953`** (2 nodes): `$sessionId.tsx`, `hasOrgNotFoundPayload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1954`** (2 nodes): `registers.$sessionId.activity.tsx`, `hasOrgNotFoundPayload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1955`** (2 nodes): `registers.index.tsx`, `hasOrgNotFoundPayload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1956`** (2 nodes): `StoreRootRedirect()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1957`** (2 nodes): `InventoryImportRoute()`, `-inventory-import-route.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1958`** (2 nodes): `ApprovalsRoute()`, `approvals.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1959`** (2 nodes): `DailyCloseHistoryRoute()`, `daily-close-history.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1960`** (2 nodes): `DailyCloseRoute()`, `daily-close.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1961`** (2 nodes): `DailyOperationsRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1962`** (2 nodes): `OpenWorkRoute()`, `open-work.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1963`** (2 nodes): `DailyOpeningRoute()`, `opening.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1964`** (2 nodes): `stock-adjustments.tsx`, `StockAdjustmentsRoute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1965`** (2 nodes): `ExpenseRouteComponent()`, `expense.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1966`** (2 nodes): `settings.index.tsx`, `SettingsNotFoundComponent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1967`** (2 nodes): `terminals.route.test.tsx`, `routeBuilder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1968`** (2 nodes): `ComplimentaryProductsNotFoundComponent()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1969`** (2 nodes): `ProductsNotFoundComponent()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1970`** (2 nodes): `ReportsItemsRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1971`** (2 nodes): `published.index.tsx`, `RouteComponent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1972`** (2 nodes): `shared-demo.tsx`, `SharedDemoHomeRoute()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1973`** (2 nodes): `_authed.route.test.tsx`, `_authed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1974`** (2 nodes): `setQuery()`, `docs.reports.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1975`** (2 nodes): `SolutionDocContent()`, `docs.solutions.$category.$slug.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1976`** (2 nodes): `AthenaLoginReadyView()`, `-login-ready-view.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1977`** (2 nodes): `activeHandoff()`, `_layout.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1978`** (2 nodes): `waiver.approve.tsx`, `approve()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1979`** (2 nodes): `OrganizationSettingsAccordion()`, `OrganizationsSettingsAccordion.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1980`** (2 nodes): `PatternsOverview()`, `Overview.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1981`** (2 nodes): `view-patterns.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1982`** (2 nodes): `ControlsShowcase()`, `Controls.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1983`** (2 nodes): `DialogShowcase()`, `Dialog.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1984`** (2 nodes): `FeedbackShowcase()`, `Feedback.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1985`** (2 nodes): `PrimitivesOverview()`, `Overview.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1986`** (2 nodes): `Popover.stories.tsx`, `PopoverShowcase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1987`** (2 nodes): `Sheet.stories.tsx`, `SheetShowcase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1988`** (2 nodes): `Tooltip.stories.tsx`, `TooltipShowcase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1989`** (2 nodes): `TemplatesOverview()`, `Overview.stories.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1990`** (2 nodes): `wedAt()`, `dailyOperationsFixtures.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1991`** (2 nodes): `wedAt()`, `openingHandoffFixtures.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1992`** (2 nodes): `momentAt()`, `operationsFixtureContext.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1993`** (2 nodes): `posHubFixtures.ts`, `buildTrend()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1994`** (2 nodes): `demoJourneyDate()`, `journeyDate.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1995`** (2 nodes): `formatNumber()`, `formatNumber.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1996`** (2 nodes): `getBannerMessage()`, `bannerMessage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1997`** (2 nodes): `jsonResponse()`, `checkoutSession.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1998`** (2 nodes): `updateGuest()`, `guest.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1999`** (2 nodes): `getHomepageSnapshot()`, `homepageSnapshot.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2000`** (2 nodes): `posTransaction.test.ts`, `jsonResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2001`** (2 nodes): `storefront.ts`, `getStore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2002`** (2 nodes): `trackingEvents.ts`, `postTrackingEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2003`** (2 nodes): `EntityPage()`, `EntityPage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2004`** (2 nodes): `ProductsPage.tsx`, `ProductCardLoadingSkeleton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2005`** (2 nodes): `AuthComponent()`, `Auth.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2006`** (2 nodes): `toBagSummaryItems()`, `BagSummary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2007`** (2 nodes): `CheckoutForm()`, `CheckoutForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2008`** (2 nodes): `CheckoutProvider()`, `CheckoutProvider.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2009`** (2 nodes): `EnteredBillingAddressDetails()`, `EnteredBillingAddressDetails.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2010`** (2 nodes): `OrderSummary()`, `OrderSummary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2011`** (2 nodes): `PickupDetails()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2012`** (2 nodes): `PaymentMethodSection.tsx`, `PaymentMethodSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2013`** (2 nodes): `PaymentSection.tsx`, `PaymentSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2014`** (2 nodes): `calculateDeliveryFee()`, `deliveryFees.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2015`** (2 nodes): `deriveCheckoutState()`, `deriveCheckoutState.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2016`** (2 nodes): `getIssueMap()`, `checkoutSchemas.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2017`** (2 nodes): `webOrderSchema.test.ts`, `getIssueMap()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2018`** (2 nodes): `onSubmit()`, `CustomerDetailsForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2019`** (2 nodes): `onSubmit()`, `DeliveryDetailsForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2020`** (2 nodes): `useCountdown()`, `hooks.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2021`** (2 nodes): `TrustSignals.tsx`, `TrustSignals()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2022`** (2 nodes): `ProductFilter.tsx`, `ProductFilter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2023`** (2 nodes): `handleCheckboxChange()`, `Filter.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2024`** (2 nodes): `BestSellersSection()`, `BestSellersSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2025`** (2 nodes): `handleOnLinkClick()`, `BagMenu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2026`** (2 nodes): `MobileBagMenu()`, `MobileBagMenu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2027`** (2 nodes): `SiteBanner.tsx`, `SiteBanner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2028`** (2 nodes): `NotificationPill()`, `NotificationPill.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2029`** (2 nodes): `mapValueToLabelIndex()`, `DimensionBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2030`** (2 nodes): `DiscountBadge()`, `DiscountBadge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2031`** (2 nodes): `handleClickOnPreview()`, `GalleryViewer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2032`** (2 nodes): `OnsaleProduct()`, `OnSaleProduct.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2033`** (2 nodes): `ProductActions.tsx`, `ProductActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2034`** (2 nodes): `ProductAttributes.tsx`, `ProductAttributes()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2035`** (2 nodes): `ProductPage.test.tsx`, `makePageState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2036`** (2 nodes): `ProductPage.tsx`, `showShippingPolicy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2037`** (2 nodes): `ProductReview.tsx`, `handleHelpful()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2038`** (2 nodes): `ReviewSummary.tsx`, `ReviewSummary()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2039`** (2 nodes): `OrderItem()`, `OrderItem.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2040`** (2 nodes): `RatingSelector.tsx`, `RatingSelector()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2041`** (2 nodes): `GuestRewardsPrompt()`, `GuestRewardsPrompt.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2042`** (2 nodes): `OrderPointsDisplay()`, `OrderPointsDisplay.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2043`** (2 nodes): `PastOrdersRewards.tsx`, `handleClaimPoints()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2044`** (2 nodes): `RewardsPanel.tsx`, `handleRedeemReward()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2045`** (2 nodes): `BagItem()`, `BagItem.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2046`** (2 nodes): `CheckoutUnavailable()`, `CheckoutUnavailable.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2047`** (2 nodes): `ErrorBoundary()`, `ErrorBoundary.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2048`** (2 nodes): `ScrollDownButton.tsx`, `ScrollDownButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2049`** (2 nodes): `CountrySelect()`, `country-select.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2050`** (2 nodes): `GhanaRegionSelect()`, `ghana-region-select.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2051`** (2 nodes): `GhostButton()`, `ghost-button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2052`** (2 nodes): `handleClose()`, `LeaveAReviewModal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2053`** (2 nodes): `UpsellModalSuccess.tsx`, `UpsellModalSuccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2054`** (2 nodes): `WelcomeBackModalSuccess.tsx`, `WelcomeBackModalSuccess()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2055`** (2 nodes): `getModalConfig()`, `leaveReviewModalConfig.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2056`** (2 nodes): `welcomeBackModalConfig.tsx`, `getModalConfig()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2057`** (2 nodes): `webp-jpg.tsx`, `WebpImage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2058`** (2 nodes): `useFormSubmission()`, `FormSubmissionProvider.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2059`** (2 nodes): `StoreContext.characterization.test.tsx`, `Probe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2060`** (2 nodes): `useCheckout.ts`, `useCheckout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2061`** (2 nodes): `useDiscountCodeAlert.tsx`, `useDiscountCodeAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2062`** (2 nodes): `useEnhancedTracking.ts`, `useEnhancedTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2063`** (2 nodes): `useGetActiveCheckoutSession.tsx`, `useGetActiveCheckoutSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2064`** (2 nodes): `useGetProduct.tsx`, `useGetProductQuery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2065`** (2 nodes): `useGetProductFilters.ts`, `useGetProductFilters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2066`** (2 nodes): `useGetProductReviews.ts`, `useGetProductReviewsQuery()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2067`** (2 nodes): `useGetStore.ts`, `useGetStore()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2068`** (2 nodes): `useInventoryStatus.ts`, `useInventoryStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2069`** (2 nodes): `useLeaveAReviewModal.tsx`, `useLeaveAReviewModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2070`** (2 nodes): `useLogout.ts`, `useLogout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2071`** (2 nodes): `useModalState.tsx`, `useModalState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2072`** (2 nodes): `useProductPageLogic.ts`, `useProductPageLogic()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2073`** (2 nodes): `useProductReminder.tsx`, `useProductReminder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2074`** (2 nodes): `usePromoAlert.tsx`, `usePromoAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2075`** (2 nodes): `useQueryEnabled.ts`, `useQueryEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2076`** (2 nodes): `useRewardsAlert.tsx`, `useRewardsAlert()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2077`** (2 nodes): `useScrollToTop.ts`, `useScrollToTop()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2078`** (2 nodes): `useTrackAction.ts`, `useTrackAction()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2079`** (2 nodes): `useTrackEvent.ts`, `useTrackEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2080`** (2 nodes): `useUpsellModal.tsx`, `useUpsellModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2081`** (2 nodes): `usePostAnalytics()`, `analytics.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2082`** (2 nodes): `useBagQueries()`, `bag.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2083`** (2 nodes): `useBannerMessageQueries()`, `bannerMessage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2084`** (2 nodes): `useCheckoutSessionQueries()`, `checkout.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2085`** (2 nodes): `useHomepageSnapshotQueries()`, `homepageSnapshot.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2086`** (2 nodes): `useInventoryQueries()`, `inventory.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2087`** (2 nodes): `useOnlineOrderQueries()`, `onlineOrder.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2088`** (2 nodes): `posTransaction.ts`, `usePosTransactionQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2089`** (2 nodes): `product.ts`, `useProductQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2090`** (2 nodes): `promoCode.ts`, `usePromoCodesQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2091`** (2 nodes): `reviews.ts`, `useReviewQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2092`** (2 nodes): `rewards.ts`, `useRewardsQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2093`** (2 nodes): `upsells.ts`, `useUpsellsQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2094`** (2 nodes): `user.ts`, `useUserQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2095`** (2 nodes): `userOffers.ts`, `useUserOffersQueries()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2096`** (2 nodes): `storeConfig.test.ts`, `buildV2Config()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2097`** (2 nodes): `storefrontObservability.test.ts`, `createMemoryStorage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2098`** (2 nodes): `validateEmail()`, `email.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2099`** (2 nodes): `App()`, `main.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2100`** (2 nodes): `router.tsx`, `createRouter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2101`** (2 nodes): `loadHomePageData()`, `-homePageLoader.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2102`** (2 nodes): `LayoutComponent()`, `_ordersLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2103`** (2 nodes): `ContactUs()`, `contact-us.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2104`** (2 nodes): `OnlineOrderPolicy()`, `delivery-returns-exchanges.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2105`** (2 nodes): `privacy.index.tsx`, `PrivacyPolicy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2106`** (2 nodes): `tos.index.tsx`, `TosSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2107`** (2 nodes): `shop.product.$productSlug.tsx`, `Component()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2108`** (2 nodes): `LayoutComponent()`, `_layout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2109`** (2 nodes): `HomeRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2110`** (2 nodes): `CheckoutCanceledView()`, `canceled.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2111`** (2 nodes): `CheckoutComplete()`, `complete.index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2112`** (2 nodes): `pod-confirmation.tsx`, `completePODCheckoutSession()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2113`** (2 nodes): `ReceiptShareRoute()`, `index.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2114`** (2 nodes): `test-connection.js`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2115`** (2 nodes): `run()`, `architecture-boundary-check.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2116`** (2 nodes): `fixture()`, `delivery-diff-fingerprint.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2117`** (2 nodes): `git()`, `delivery-documentation-admission.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2118`** (2 nodes): `invokeAdapter()`, `delivery-emit.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2119`** (2 nodes): `invoke()`, `delivery-live-sensor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2120`** (2 nodes): `productRunFixture()`, `delivery-run-telemetry.fixtures.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2121`** (2 nodes): `readRepoFile()`, `deploy-qa-vps.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2122`** (2 nodes): `fixture()`, `docs-solution-link-check.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2123`** (2 nodes): `requestJson()`, `documentation-waiver-attestation.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2124`** (2 nodes): `workflow()`, `documentation-waiver-workflows.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2125`** (2 nodes): `withoutGitRepositoryContext()`, `git-environment.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2126`** (2 nodes): `runCommand()`, `github-pr-merge.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2127`** (2 nodes): `git()`, `harness-base-config-loader.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2128`** (2 nodes): `loadHarnessBaseConfig()`, `harness-base-config-loader.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2129`** (2 nodes): `shutdown()`, `athena-runtime-app.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2130`** (2 nodes): `shutdown()`, `sample-app.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2131`** (2 nodes): `git()`, `harness-review-coverage.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2132`** (2 nodes): `reviewEvidenceArguments()`, `harness-review-evidence.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2133`** (2 nodes): `buildReportLine()`, `harness-runtime-trends.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2134`** (2 nodes): `fixture()`, `harness-validation-ci-admission.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2135`** (2 nodes): `admitFinalValidationHealth()`, `harness-validation-ci-admission.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2136`** (2 nodes): `fixture()`, `harness-validation-ci-diagnostics-official.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2137`** (2 nodes): `fixture()`, `harness-validation-ci-final.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2138`** (2 nodes): `full()`, `harness-validation-health-inventory.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2139`** (2 nodes): `lifecycle()`, `policy-projection-check.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2140`** (2 nodes): `checkPolicyProjection()`, `policy-projection-check.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2141`** (2 nodes): `fixture()`, `pr-athena-delivery-run.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2142`** (2 nodes): `readRepoFile()`, `pr-athena-guidance-contract.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2143`** (2 nodes): `runPrAthenaPreparation()`, `pr-athena-prepare.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2144`** (2 nodes): `runPrePushReview()`, `pre-push-review.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2145`** (2 nodes): `validate-plan-html.test.ts`, `createTempRepo()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2146`** (1 nodes): `convexModel.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2147`** (1 nodes): `homepageRanking.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2148`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2149`** (1 nodes): `intelligence.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2150`** (1 nodes): `models.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2151`** (1 nodes): `storeConfig.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2152`** (1 nodes): `api.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2153`** (1 nodes): `api.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 2154`** (1 nodes): `dataModel.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 