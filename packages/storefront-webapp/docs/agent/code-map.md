...
- Runtime entrypoints: [index.html](../../index.html), [src/main.tsx](../../src/main.tsx), [src/router.tsx](../../src/router.tsx), [src/routes/__root.tsx](../../src/routes/__root.tsx)
...
- Intelligence context events: [src/lib/storefrontContextEvents.ts](../../src/lib/storefrontContextEvents.ts), [src/api/trackingEvents.ts](../../src/api/trackingEvents.ts). These are the forward path for intelligence-bearing storefront milestones; legacy analytics helpers are not a readout compiler source.
