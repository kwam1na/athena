...
- [`src/api`](../../src/api) — Backend-facing request wrappers and typed API helpers. Currently 27 file(s); key children: analytics.test.ts, analytics.ts, auth.ts, bag.ts, bannerMessage.ts.
