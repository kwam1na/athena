...
- [`src/components`](../../src/components) — Reusable storefront UI and feature-specific checkout/catalog components. Currently 192 file(s); key children: DefaultCatchBoundary.tsx, EntityPage.tsx, HomePage.test.tsx, HomePage.tsx, ProductActionBar.tsx.
...
- [`src/contexts`](../../src/contexts) — Shared client providers for store, navigation, and observability state. Currently 6 file(s); key children: FormSubmissionProvider.tsx, NavigationBarProvider.tsx, StoreContext.characterization.test.tsx, StoreContext.tsx, StorefrontObservabilityProvider.test.tsx.
