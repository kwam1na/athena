...
- [`src/lib`](../../src/lib) — Shared utilities, query helpers, schemas, and domain logic. Currently 48 file(s); key children: STOREFRONT_OBSERVABILITY.md, constants.ts, countries.ts, currency.ts, feeUtils.test.ts.
- [`src/api`](../../src/api) — Backend-facing request wrappers and typed API helpers. Currently 28 file(s); key children: analytics.test.ts, analytics.ts, auth.ts, bag.ts, bannerMessage.ts.
