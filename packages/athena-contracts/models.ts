...
/**
 * The anonymous catalogue routes (`GET /products`, `/products/:id`,
 * `/products/bestSellers`, `/products/featured`) answer with a drop-only
 * public projection of the catalogue documents: same field names, minus the
 * operator-internal ones. `convex/storeFront/publicCatalog.ts` is the runtime
 * projection these types describe.
 */
export type PublicCatalogSku = Omit<
  ProductSku,
  | "barcode"
