/**
 * Document-backed contracts shared by the Athena admin app, the storefront, and
 * the POS surfaces.
 *
 * These are projections of the generated Convex data model. They reach it only
 * through `./convexModel`, which is the single sanctioned seam into
 * `packages/athena-webapp/convex/**`.
 */
import type { Doc, Id } from "./convexModel";
