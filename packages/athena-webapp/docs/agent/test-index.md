...
- [`convex/reporting/factFingerprint.test.ts`](../../convex/reporting/factFingerprint.test.ts)
...
- [`convex/reporting/maintenance/authorizedPosBackfill.test.ts`](../../convex/reporting/maintenance/authorizedPosBackfill.test.ts)
- [`convex/reporting/maintenance/backfill.test.ts`](../../convex/reporting/maintenance/backfill.test.ts)
- [`convex/reporting/maintenance/backfillAuthorization.test.ts`](../../convex/reporting/maintenance/backfillAuthorization.test.ts)
...
- [`convex/reporting/maintenance/legacyCompatibility.test.ts`](../../convex/reporting/maintenance/legacyCompatibility.test.ts)
- [`convex/reporting/maintenance/posCensusBackfill.test.ts`](../../convex/reporting/maintenance/posCensusBackfill.test.ts)
- [`convex/reporting/maintenance/posSourceReconciliation.test.ts`](../../convex/reporting/maintenance/posSourceReconciliation.test.ts)
- [`convex/reporting/maintenance/posSourceReconciliationGate.test.ts`](../../convex/reporting/maintenance/posSourceReconciliationGate.test.ts)
...
- [`convex/reporting/periods.test.ts`](../../convex/reporting/periods.test.ts)
...
- [`convex/reporting/projections/dailyCloseTrust.test.ts`](../../convex/reporting/projections/dailyCloseTrust.test.ts)
...
- [`convex/reporting/projections/storeIntraday.test.ts`](../../convex/reporting/projections/storeIntraday.test.ts)
- [`convex/reporting/public.test.ts`](../../convex/reporting/public.test.ts)
- [`convex/reporting/readModels/destinations.test.ts`](../../convex/reporting/readModels/destinations.test.ts)
- [`convex/reporting/readModels/materialize.test.ts`](../../convex/reporting/readModels/materialize.test.ts)
- [`convex/reporting/readModels/readBundle.test.ts`](../../convex/reporting/readModels/readBundle.test.ts)
- [`convex/reporting/readModels/reportingReadModels.test.ts`](../../convex/reporting/readModels/reportingReadModels.test.ts)
...
- [`convex/reporting/skuAttributionSequence.test.ts`](../../convex/reporting/skuAttributionSequence.test.ts)
- [`convex/reporting/sourceAdapters.test.ts`](../../convex/reporting/sourceAdapters.test.ts)
- [`convex/reporting/storeTimeAuthority.test.ts`](../../convex/reporting/storeTimeAuthority.test.ts)
...
- [`src/components/reports/CustomRangeStatus.test.tsx`](../../src/components/reports/CustomRangeStatus.test.tsx)
- [`src/components/reports/ReportPeriodControl.test.tsx`](../../src/components/reports/ReportPeriodControl.test.tsx)
- [`src/components/reports/ReportsInventoryView.test.tsx`](../../src/components/reports/ReportsInventoryView.test.tsx)
...
- [`src/components/reports/ReportsSkuEvidenceList.test.tsx`](../../src/components/reports/ReportsSkuEvidenceList.test.tsx)
- [`src/components/reports/ReportsWorkspace.integration.test.tsx`](../../src/components/reports/ReportsWorkspace.integration.test.tsx)
- [`src/components/reports/ReportsWorkspaceControls.test.tsx`](../../src/components/reports/ReportsWorkspaceControls.test.tsx)
- [`src/components/reports/reportPresentation.test.ts`](../../src/components/reports/reportPresentation.test.ts)
...
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/search.test.ts`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/search.test.ts)
