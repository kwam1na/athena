...
- [`convex/agentHarness/citations.test.ts`](../../convex/agentHarness/citations.test.ts)
- [`convex/agentHarness/completionOutbox.test.ts`](../../convex/agentHarness/completionOutbox.test.ts)
- [`convex/agentHarness/conformance.test.ts`](../../convex/agentHarness/conformance.test.ts)
- [`convex/agentHarness/dataGovernance.test.ts`](../../convex/agentHarness/dataGovernance.test.ts)
- [`convex/agentHarness/delegatedAdmission.test.ts`](../../convex/agentHarness/delegatedAdmission.test.ts)
- [`convex/agentHarness/deploymentState.test.ts`](../../convex/agentHarness/deploymentState.test.ts)
- [`convex/agentHarness/discovery.test.ts`](../../convex/agentHarness/discovery.test.ts)
- [`convex/agentHarness/egressPolicy.test.ts`](../../convex/agentHarness/egressPolicy.test.ts)
- [`convex/agentHarness/evals/dailyOperations.ports.test.ts`](../../convex/agentHarness/evals/dailyOperations.ports.test.ts)
- [`convex/agentHarness/evals/dailyOperations.smoke.test.ts`](../../convex/agentHarness/evals/dailyOperations.smoke.test.ts)
- [`convex/agentHarness/evals/dailyOperations.test.ts`](../../convex/agentHarness/evals/dailyOperations.test.ts)
- [`convex/agentHarness/evals/syntheticSecondSurface.test.ts`](../../convex/agentHarness/evals/syntheticSecondSurface.test.ts)
- [`convex/agentHarness/evidence.test.ts`](../../convex/agentHarness/evidence.test.ts)
- [`convex/agentHarness/executor.test.ts`](../../convex/agentHarness/executor.test.ts)
- [`convex/agentHarness/grants.test.ts`](../../convex/agentHarness/grants.test.ts)
- [`convex/agentHarness/historyProjection.test.ts`](../../convex/agentHarness/historyProjection.test.ts)
...
- [`convex/agentHarness/programRuntime/fieldAdvisories.test.ts`](../../convex/agentHarness/programRuntime/fieldAdvisories.test.ts)
- [`convex/agentHarness/programRuntime/runtimeSpike.test.ts`](../../convex/agentHarness/programRuntime/runtimeSpike.test.ts)
- [`convex/agentHarness/provisionalNarrative.test.ts`](../../convex/agentHarness/provisionalNarrative.test.ts)
- [`convex/agentHarness/readPorts.test.ts`](../../convex/agentHarness/readPorts.test.ts)
- [`convex/agentHarness/releaseConformance.test.ts`](../../convex/agentHarness/releaseConformance.test.ts)
- [`convex/agentHarness/retention.test.ts`](../../convex/agentHarness/retention.test.ts)
- [`convex/agentHarness/runAdmission.test.ts`](../../convex/agentHarness/runAdmission.test.ts)
- [`convex/agentHarness/runtimeHost.test.ts`](../../convex/agentHarness/runtimeHost.test.ts)
- [`convex/agentHarness/runtimeRetention.test.ts`](../../convex/agentHarness/runtimeRetention.test.ts)
- [`convex/agentHarness/scorecard.test.ts`](../../convex/agentHarness/scorecard.test.ts)
- [`convex/agentHarness/scorecardQuery.test.ts`](../../convex/agentHarness/scorecardQuery.test.ts)
...
- [`convex/auth/SharedDemoTicket.test.ts`](../../convex/auth/SharedDemoTicket.test.ts)
- [`convex/authConfig.test.ts`](../../convex/authConfig.test.ts)
- [`convex/automation/agentCapabilities/seams.characterization.test.ts`](../../convex/automation/agentCapabilities/seams.characterization.test.ts)
...
- [`convex/cashControls/agentCapabilities/seams.characterization.test.ts`](../../convex/cashControls/agentCapabilities/seams.characterization.test.ts)
...
- [`convex/cloudflare/stream.admission.test.ts`](../../convex/cloudflare/stream.admission.test.ts)
- [`convex/contextTracking/athenaWebappEvents.test.ts`](../../convex/contextTracking/athenaWebappEvents.test.ts)
...
- [`convex/contextTracking/sharedDemoActionCapture.test.ts`](../../convex/contextTracking/sharedDemoActionCapture.test.ts)
- [`convex/contextTracking/sharedDemoActivity.test.ts`](../../convex/contextTracking/sharedDemoActivity.test.ts)
- [`convex/contextTracking/sharedDemoEvents.admission.test.ts`](../../convex/contextTracking/sharedDemoEvents.admission.test.ts)
- [`convex/contextTracking/sharedDemoEvents.test.ts`](../../convex/contextTracking/sharedDemoEvents.test.ts)
...
- [`convex/harnessWaiver/passkeyPolicy.test.ts`](../../convex/harnessWaiver/passkeyPolicy.test.ts)
- [`convex/harnessWaiver/passkeys.admission.test.ts`](../../convex/harnessWaiver/passkeys.admission.test.ts)
- [`convex/harnessWaiver/passkeys.integration.test.ts`](../../convex/harnessWaiver/passkeys.integration.test.ts)
- [`convex/harnessWaiver/passkeys.test.ts`](../../convex/harnessWaiver/passkeys.test.ts)
- [`convex/harnessWaiver/registrationAuthorization.test.ts`](../../convex/harnessWaiver/registrationAuthorization.test.ts)
- [`convex/harnessWaiver/storage.test.ts`](../../convex/harnessWaiver/storage.test.ts)
- [`convex/http/domains/core/routes/assistantCatalog.test.ts`](../../convex/http/domains/core/routes/assistantCatalog.test.ts)
- [`convex/http/domains/core/routes/assistantHeaderLogging.test.ts`](../../convex/http/domains/core/routes/assistantHeaderLogging.test.ts)
- [`convex/http/domains/core/routes/bannerMessage.test.ts`](../../convex/http/domains/core/routes/bannerMessage.test.ts)
- [`convex/http/domains/core/routes/coreAdmission.test.ts`](../../convex/http/domains/core/routes/coreAdmission.test.ts)
- [`convex/http/domains/core/routes/harnessWaivers.test.ts`](../../convex/http/domains/core/routes/harnessWaivers.test.ts)
- [`convex/http/domains/core/routes/landingFunnelEvents.test.ts`](../../convex/http/domains/core/routes/landingFunnelEvents.test.ts)
- [`convex/http/domains/core/routes/products.test.ts`](../../convex/http/domains/core/routes/products.test.ts)
...
- [`convex/http/domains/core/routes/walkthroughRequests.test.ts`](../../convex/http/domains/core/routes/walkthroughRequests.test.ts)
- [`convex/http/domains/customerChannel/routes/checkoutRoutes.test.ts`](../../convex/http/domains/customerChannel/routes/checkoutRoutes.test.ts)
- [`convex/http/domains/customerChannel/routes/customerChannelAdmission.test.ts`](../../convex/http/domains/customerChannel/routes/customerChannelAdmission.test.ts)
- [`convex/http/domains/customerChannel/routes/guestMergeGrant.test.ts`](../../convex/http/domains/customerChannel/routes/guestMergeGrant.test.ts)
...
- [`convex/http/domains/customerChannel/routes/posTransaction.test.ts`](../../convex/http/domains/customerChannel/routes/posTransaction.test.ts)
- [`convex/http/domains/customerChannel/routes/savedBagItemOwnership.test.ts`](../../convex/http/domains/customerChannel/routes/savedBagItemOwnership.test.ts)
...
- [`convex/http/domains/customerMessaging/routes/whatsappWebhookBody.test.ts`](../../convex/http/domains/customerMessaging/routes/whatsappWebhookBody.test.ts)
- [`convex/http/domains/moneyMovement/routes/mtnMomoWebhookBody.test.ts`](../../convex/http/domains/moneyMovement/routes/mtnMomoWebhookBody.test.ts)
...
- [`convex/http/utils.test.ts`](../../convex/http/utils.test.ts)
...
- [`convex/intelligence/runs.admission.test.ts`](../../convex/intelligence/runs.admission.test.ts)
- [`convex/intelligence/runs.test.ts`](../../convex/intelligence/runs.test.ts)
- [`convex/inventory/athenaUser.test.ts`](../../convex/inventory/athenaUser.test.ts)
...
- [`convex/inventory/catalogAccess.test.ts`](../../convex/inventory/catalogAccess.test.ts)
- [`convex/inventory/catalogAccessAdapter.test.ts`](../../convex/inventory/catalogAccessAdapter.test.ts)
...
- [`convex/inventory/inventoryCatalogAdmission.test.ts`](../../convex/inventory/inventoryCatalogAdmission.test.ts)
- [`convex/inventory/inventoryIdentityAdmission.sharedDemo.test.ts`](../../convex/inventory/inventoryIdentityAdmission.sharedDemo.test.ts)
- [`convex/inventory/inventoryIdentityAdmission.test.ts`](../../convex/inventory/inventoryIdentityAdmission.test.ts)
- [`convex/inventory/inventoryImportCostOverlay.test.ts`](../../convex/inventory/inventoryImportCostOverlay.test.ts)
- [`convex/inventory/inventoryImportCostOverlayOrchestration.test.ts`](../../convex/inventory/inventoryImportCostOverlayOrchestration.test.ts)
- [`convex/inventory/inventoryImportCostOverlayWork.test.ts`](../../convex/inventory/inventoryImportCostOverlayWork.test.ts)
...
- [`convex/inventory/organizations.test.ts`](../../convex/inventory/organizations.test.ts)
...
- [`convex/inventoryLedger/commerceEffects.test.ts`](../../convex/inventoryLedger/commerceEffects.test.ts)
- [`convex/inventoryLedger/corrections.test.ts`](../../convex/inventoryLedger/corrections.test.ts)
- [`convex/inventoryLedger/deficitResolutionWork.test.ts`](../../convex/inventoryLedger/deficitResolutionWork.test.ts)
- [`convex/inventoryLedger/effects.test.ts`](../../convex/inventoryLedger/effects.test.ts)
- [`convex/inventoryLedger/valuation.test.ts`](../../convex/inventoryLedger/valuation.test.ts)
...
- [`convex/lib/storeMemberAccess.test.ts`](../../convex/lib/storeMemberAccess.test.ts)
- [`convex/llm/insights.admission.test.ts`](../../convex/llm/insights.admission.test.ts)
- [`convex/mailersend/index.test.tsx`](../../convex/mailersend/index.test.tsx)
- [`convex/marketing/landingFunnelEvents.test.ts`](../../convex/marketing/landingFunnelEvents.test.ts)
- [`convex/marketing/landingFunnelRetention.test.ts`](../../convex/marketing/landingFunnelRetention.test.ts)
- [`convex/marketing/walkthroughConfig.test.ts`](../../convex/marketing/walkthroughConfig.test.ts)
- [`convex/marketing/walkthroughRequestNotifications.test.ts`](../../convex/marketing/walkthroughRequestNotifications.test.ts)
...
- [`convex/migrations/backfillAmountsToPesewas.test.ts`](../../convex/migrations/backfillAmountsToPesewas.test.ts)
- [`convex/migrations/backfillAthenaUserNormalizedEmail.test.ts`](../../convex/migrations/backfillAthenaUserNormalizedEmail.test.ts)
- [`convex/migrations/backfillProductSkuSearchAssistantFields.test.ts`](../../convex/migrations/backfillProductSkuSearchAssistantFields.test.ts)
- [`convex/migrations/backfillReportFactObservedAt.test.ts`](../../convex/migrations/backfillReportFactObservedAt.test.ts)
...
- [`convex/operationAdmission/capabilities.test.ts`](../../convex/operationAdmission/capabilities.test.ts)
- [`convex/operationAdmission/coverage.test.ts`](../../convex/operationAdmission/coverage.test.ts)
- [`convex/operationAdmission/definitions.test.ts`](../../convex/operationAdmission/definitions.test.ts)
- [`convex/operationAdmission/importAllowlist.test.ts`](../../convex/operationAdmission/importAllowlist.test.ts)
- [`convex/operationAdmission/ingressVerification.test.ts`](../../convex/operationAdmission/ingressVerification.test.ts)
- [`convex/operationAdmission/rail.test.ts`](../../convex/operationAdmission/rail.test.ts)
- [`convex/operationAdmission/readAdapters.test.ts`](../../convex/operationAdmission/readAdapters.test.ts)
- [`convex/operationAdmission/readDefinitions.test.ts`](../../convex/operationAdmission/readDefinitions.test.ts)
- [`convex/operations/agentCapabilities/seams.characterization.test.ts`](../../convex/operations/agentCapabilities/seams.characterization.test.ts)
...
- [`convex/operations/inventoryContributionRebuild.test.ts`](../../convex/operations/inventoryContributionRebuild.test.ts)
- [`convex/operations/inventoryContributionWriteSites.test.ts`](../../convex/operations/inventoryContributionWriteSites.test.ts)
- [`convex/operations/inventoryContributions.integration.test.ts`](../../convex/operations/inventoryContributions.integration.test.ts)
- [`convex/operations/inventoryContributions.test.ts`](../../convex/operations/inventoryContributions.test.ts)
...
- [`convex/operations/oversizedOperationalWorkRepair.test.ts`](../../convex/operations/oversizedOperationalWorkRepair.test.ts)
- [`convex/operations/owedDailyCloseSweep.integration.test.ts`](../../convex/operations/owedDailyCloseSweep.integration.test.ts)
- [`convex/operations/owedDailyCloseSweep.test.ts`](../../convex/operations/owedDailyCloseSweep.test.ts)
...
- [`convex/operations/weeklyManagerReportEmail.test.ts`](../../convex/operations/weeklyManagerReportEmail.test.ts)
...
- [`convex/platform/admitPublicAction.test.ts`](../../convex/platform/admitPublicAction.test.ts)
- [`convex/platform/admitPublicMutation.test.ts`](../../convex/platform/admitPublicMutation.test.ts)
- [`convex/platform/admitPublicQuery.test.ts`](../../convex/platform/admitPublicQuery.test.ts)
- [`convex/platform/capabilityCatalog.test.ts`](../../convex/platform/capabilityCatalog.test.ts)
...
- [`convex/pos/application/clientEventRetention.test.ts`](../../convex/pos/application/clientEventRetention.test.ts)
...
- [`convex/pos/application/sync/deadLetter.test.ts`](../../convex/pos/application/sync/deadLetter.test.ts)
...
- [`convex/pos/application/sync/reconcileSequenceGaps.test.ts`](../../convex/pos/application/sync/reconcileSequenceGaps.test.ts)
...
- [`convex/pos/application/sync/registerSessionSyncReview.classify.test.ts`](../../convex/pos/application/sync/registerSessionSyncReview.classify.test.ts)
- [`convex/pos/application/sync/resolveLocalSyncReview.test.ts`](../../convex/pos/application/sync/resolveLocalSyncReview.test.ts)
- [`convex/pos/application/sync/sequenceGapPolicy.test.ts`](../../convex/pos/application/sync/sequenceGapPolicy.test.ts)
...
- [`convex/pos/application/terminalRuntime/terminalHealthAlerts.test.ts`](../../convex/pos/application/terminalRuntime/terminalHealthAlerts.test.ts)
...
- [`convex/pos/infrastructure/posLifecycleJournal.test.ts`](../../convex/pos/infrastructure/posLifecycleJournal.test.ts)
...
- [`convex/pos/public/telemetry.test.ts`](../../convex/pos/public/telemetry.test.ts)
...
- [`convex/remoteAssist/transport.admission.test.ts`](../../convex/remoteAssist/transport.admission.test.ts)
- [`convex/remoteAssist/transportInternal.test.ts`](../../convex/remoteAssist/transportInternal.test.ts)
- [`convex/reports/access.test.ts`](../../convex/reports/access.test.ts)
- [`convex/reports/agentCapabilities/seams.characterization.test.ts`](../../convex/reports/agentCapabilities/seams.characterization.test.ts)
- [`convex/reports/closeEvidence.test.ts`](../../convex/reports/closeEvidence.test.ts)
- [`convex/reports/contract.test.ts`](../../convex/reports/contract.test.ts)
- [`convex/reports/customRange.test.ts`](../../convex/reports/customRange.test.ts)
- [`convex/reports/fingerprint.test.ts`](../../convex/reports/fingerprint.test.ts)
- [`convex/reports/foldDay.test.ts`](../../convex/reports/foldDay.test.ts)
- [`convex/reports/foldVersionRepair.test.ts`](../../convex/reports/foldVersionRepair.test.ts)
- [`convex/reports/ingest.test.ts`](../../convex/reports/ingest.test.ts)
- [`convex/reports/liveDay.test.ts`](../../convex/reports/liveDay.test.ts)
- [`convex/reports/operatingDay.test.ts`](../../convex/reports/operatingDay.test.ts)
- [`convex/reports/overview.test.ts`](../../convex/reports/overview.test.ts)
- [`convex/reports/pipelineAcceptedParity.test.ts`](../../convex/reports/pipelineAcceptedParity.test.ts)
- [`convex/reports/pipelineAcceptedWatermark.test.ts`](../../convex/reports/pipelineAcceptedWatermark.test.ts)
- [`convex/reports/pipelineAcceptedWriteSites.test.ts`](../../convex/reports/pipelineAcceptedWriteSites.test.ts)
- [`convex/reports/pipelineCharacterization.test.ts`](../../convex/reports/pipelineCharacterization.test.ts)
- [`convex/reports/pipelineCloseBackfill.test.ts`](../../convex/reports/pipelineCloseBackfill.test.ts)
- [`convex/reports/pipelineDispatch.test.ts`](../../convex/reports/pipelineDispatch.test.ts)
- [`convex/reports/pipelineDispatchRoot.test.ts`](../../convex/reports/pipelineDispatchRoot.test.ts)
- [`convex/reports/pipelineEvidence.test.ts`](../../convex/reports/pipelineEvidence.test.ts)
- [`convex/reports/pipelineFreshness.test.ts`](../../convex/reports/pipelineFreshness.test.ts)
- [`convex/reports/pipelineIsolation.test.ts`](../../convex/reports/pipelineIsolation.test.ts)
- [`convex/reports/pipelineMaintenance.test.ts`](../../convex/reports/pipelineMaintenance.test.ts)
- [`convex/reports/pipelineMigration.test.ts`](../../convex/reports/pipelineMigration.test.ts)
- [`convex/reports/pipelineRange.test.ts`](../../convex/reports/pipelineRange.test.ts)
- [`convex/reports/pipelineReadCost.test.ts`](../../convex/reports/pipelineReadCost.test.ts)
- [`convex/reports/pipelineReadCostOptimized.test.ts`](../../convex/reports/pipelineReadCostOptimized.test.ts)
- [`convex/reports/pipelineRetention.test.ts`](../../convex/reports/pipelineRetention.test.ts)
- [`convex/reports/pipelineWeekly.test.ts`](../../convex/reports/pipelineWeekly.test.ts)
- [`convex/reports/pipelineWork.test.ts`](../../convex/reports/pipelineWork.test.ts)
- [`convex/reports/queries.test.ts`](../../convex/reports/queries.test.ts)
- [`convex/reports/rangeSnapshotLifecycle.test.ts`](../../convex/reports/rangeSnapshotLifecycle.test.ts)
- [`convex/reports/readCostTestSupport.test.ts`](../../convex/reports/readCostTestSupport.test.ts)
- [`convex/reports/reportsAdmission.test.ts`](../../convex/reports/reportsAdmission.test.ts)
- [`convex/reports/reseed.test.ts`](../../convex/reports/reseed.test.ts)
- [`convex/reports/rollupCapacity.test.ts`](../../convex/reports/rollupCapacity.test.ts)
- [`convex/reports/rollupMaintenance.test.ts`](../../convex/reports/rollupMaintenance.test.ts)
- [`convex/reports/rollupParity.test.ts`](../../convex/reports/rollupParity.test.ts)
- [`convex/reports/rollupPeriodRead.test.ts`](../../convex/reports/rollupPeriodRead.test.ts)
- [`convex/reports/rollupPipeline.test.ts`](../../convex/reports/rollupPipeline.test.ts)
- [`convex/reports/rollupWorkers.test.ts`](../../convex/reports/rollupWorkers.test.ts)
- [`convex/reports/rollups.test.ts`](../../convex/reports/rollups.test.ts)
- [`convex/reports/skuMixRange.test.ts`](../../convex/reports/skuMixRange.test.ts)
- [`convex/reports/skuMovementRange.test.ts`](../../convex/reports/skuMovementRange.test.ts)
- [`convex/reports/sweeper.test.ts`](../../convex/reports/sweeper.test.ts)
- [`convex/reports/verificationClassify.test.ts`](../../convex/reports/verificationClassify.test.ts)
- [`convex/reports/verificationSweep.test.ts`](../../convex/reports/verificationSweep.test.ts)
...
- [`convex/reports/weeklyInventoryWorker.test.ts`](../../convex/reports/weeklyInventoryWorker.test.ts)
...
- [`convex/reports/weeklyScale.test.ts`](../../convex/reports/weeklyScale.test.ts)
- [`convex/reports/weeklyVerify.test.ts`](../../convex/reports/weeklyVerify.test.ts)
...
- [`convex/sharedDemo/actor.test.ts`](../../convex/sharedDemo/actor.test.ts)
- [`convex/sharedDemo/admission.test.ts`](../../convex/sharedDemo/admission.test.ts)
- [`convex/sharedDemo/authBoundary.test.ts`](../../convex/sharedDemo/authBoundary.test.ts)
- [`convex/sharedDemo/config.test.ts`](../../convex/sharedDemo/config.test.ts)
- [`convex/sharedDemo/coverage.test.ts`](../../convex/sharedDemo/coverage.test.ts)
- [`convex/sharedDemo/demoSurfaceReads.test.ts`](../../convex/sharedDemo/demoSurfaceReads.test.ts)
- [`convex/sharedDemo/domainRestore.test.ts`](../../convex/sharedDemo/domainRestore.test.ts)
- [`convex/sharedDemo/domainRestorePipeline.test.ts`](../../convex/sharedDemo/domainRestorePipeline.test.ts)
- [`convex/sharedDemo/enforcement.test.ts`](../../convex/sharedDemo/enforcement.test.ts)
- [`convex/sharedDemo/foundation.test.ts`](../../convex/sharedDemo/foundation.test.ts)
- [`convex/sharedDemo/openingBaseline.test.ts`](../../convex/sharedDemo/openingBaseline.test.ts)
- [`convex/sharedDemo/operationAdapter.test.ts`](../../convex/sharedDemo/operationAdapter.test.ts)
- [`convex/sharedDemo/policy.test.ts`](../../convex/sharedDemo/policy.test.ts)
- [`convex/sharedDemo/posStoreReadAccessCoverage.test.ts`](../../convex/sharedDemo/posStoreReadAccessCoverage.test.ts)
...
- [`convex/sharedDemo/public.admission.test.ts`](../../convex/sharedDemo/public.admission.test.ts)
...
- [`convex/sharedDemo/readIntentGrants.test.ts`](../../convex/sharedDemo/readIntentGrants.test.ts)
- [`convex/sharedDemo/readOperationAdapter.test.ts`](../../convex/sharedDemo/readOperationAdapter.test.ts)
- [`convex/sharedDemo/registerBaseline.test.ts`](../../convex/sharedDemo/registerBaseline.test.ts)
- [`convex/sharedDemo/restore.test.ts`](../../convex/sharedDemo/restore.test.ts)
- [`convex/sharedDemo/restorePipelineStart.test.ts`](../../convex/sharedDemo/restorePipelineStart.test.ts)
- [`convex/sharedDemo/scheduledRestore.test.ts`](../../convex/sharedDemo/scheduledRestore.test.ts)
- [`convex/sharedDemo/serviceEffectBoundaryCoverage.test.ts`](../../convex/sharedDemo/serviceEffectBoundaryCoverage.test.ts)
...
- [`convex/stockOps/agentCapabilities/seams.characterization.test.ts`](../../convex/stockOps/agentCapabilities/seams.characterization.test.ts)
...
- [`convex/storeFront/assistantCatalog.test.ts`](../../convex/storeFront/assistantCatalog.test.ts)
- [`convex/storeFront/auth.test.ts`](../../convex/storeFront/auth.test.ts)
- [`convex/storeFront/checkoutSession.test.ts`](../../convex/storeFront/checkoutSession.test.ts)
- [`convex/storeFront/checkoutSessionOwnership.test.ts`](../../convex/storeFront/checkoutSessionOwnership.test.ts)
...
- [`convex/storeFront/customerOwnership.test.ts`](../../convex/storeFront/customerOwnership.test.ts)
...
- [`convex/storeFront/operationAdapter.test.ts`](../../convex/storeFront/operationAdapter.test.ts)
...
- [`convex/storeFront/publicCatalog.test.ts`](../../convex/storeFront/publicCatalog.test.ts)
- [`convex/storeFront/returnExchangeOperations.test.ts`](../../convex/storeFront/returnExchangeOperations.test.ts)
- [`convex/storeFront/storefrontCustomerAdmission.sharedDemo.test.ts`](../../convex/storeFront/storefrontCustomerAdmission.sharedDemo.test.ts)
- [`convex/storeFront/storefrontCustomerAdmission.test.ts`](../../convex/storeFront/storefrontCustomerAdmission.test.ts)
- [`convex/storeFront/storefrontObservabilityReport.test.ts`](../../convex/storeFront/storefrontObservabilityReport.test.ts)
- [`convex/storeFront/storefrontOperatorAdmission.test.ts`](../../convex/storeFront/storefrontOperatorAdmission.test.ts)
...
- [`convex/storeTime/ensureTimezoneAuthority.test.ts`](../../convex/storeTime/ensureTimezoneAuthority.test.ts)
- [`convex/storeTime/operatingPeriods.test.ts`](../../convex/storeTime/operatingPeriods.test.ts)
- [`convex/storeTime/storeTimeAuthority.test.ts`](../../convex/storeTime/storeTimeAuthority.test.ts)
...
- [`shared/agentHarness/starterIntentProgram.test.ts`](../../shared/agentHarness/starterIntentProgram.test.ts)
...
- [`shared/posDiagnosticRedaction.test.ts`](../../shared/posDiagnosticRedaction.test.ts)
...
- [`src/components/agent/AthenaAgentPanel.test.tsx`](../../src/components/agent/AthenaAgentPanel.test.tsx)
...
- [`src/components/cash-controls/registerSessionTimestamps.test.ts`](../../src/components/cash-controls/registerSessionTimestamps.test.ts)
- [`src/components/common/AnimatedDataState.test.tsx`](../../src/components/common/AnimatedDataState.test.tsx)
...
- [`src/components/homepage/Home.test.tsx`](../../src/components/homepage/Home.test.tsx)
...
- [`src/components/operations/InventoryCostOverlayView.test.tsx`](../../src/components/operations/InventoryCostOverlayView.test.tsx)
...
- [`src/components/operations/dailyOperationsAgentPresentation.test.ts`](../../src/components/operations/dailyOperationsAgentPresentation.test.ts)
- [`src/components/operations/openWorkInventoryReport.test.ts`](../../src/components/operations/openWorkInventoryReport.test.ts)
...
- [`src/components/orders/orders-table/components/orderColumns.test.tsx`](../../src/components/orders/orders-table/components/orderColumns.test.tsx)
...
- [`src/components/pos/NewTransactionView.test.tsx`](../../src/components/pos/NewTransactionView.test.tsx)
...
- [`src/components/pos/PosClientTelemetryHost.test.tsx`](../../src/components/pos/PosClientTelemetryHost.test.tsx)
...
- [`src/components/product/AnalyticsInsights.test.tsx`](../../src/components/product/AnalyticsInsights.test.tsx)
- [`src/components/product/ImagesView.test.tsx`](../../src/components/product/ImagesView.test.tsx)
...
- [`src/components/product/productStockPresentation.test.ts`](../../src/components/product/productStockPresentation.test.ts)
...
- [`src/components/products/products-table/components/data-table-row-actions.test.tsx`](../../src/components/products/products-table/components/data-table-row-actions.test.tsx)
- [`src/components/products/products-table/components/data-table-toolbar.test.tsx`](../../src/components/products/products-table/components/data-table-toolbar.test.tsx)
- [`src/components/products/products-table/components/data-table.test.tsx`](../../src/components/products/products-table/components/data-table.test.tsx)
...
- [`src/components/reports/ReportTrustStrip.test.tsx`](../../src/components/reports/ReportTrustStrip.test.tsx)
...
- [`src/components/reports/ReportsItemsView.test.tsx`](../../src/components/reports/ReportsItemsView.test.tsx)
...
- [`src/components/reports/reportRouteSearch.test.ts`](../../src/components/reports/reportRouteSearch.test.ts)
...
- [`src/components/shared-demo/SharedDemoExperience.test.tsx`](../../src/components/shared-demo/SharedDemoExperience.test.tsx)
- [`src/components/shared-demo/SharedDemoRestoreOverlay.test.tsx`](../../src/components/shared-demo/SharedDemoRestoreOverlay.test.tsx)
- [`src/components/shared-demo/SharedDemoRestrictedSurface.test.tsx`](../../src/components/shared-demo/SharedDemoRestrictedSurface.test.tsx)
- [`src/components/shared-demo/SharedDemoRuntime.test.tsx`](../../src/components/shared-demo/SharedDemoRuntime.test.tsx)
- [`src/components/shared-demo/sharedDemoActivityTracking.test.ts`](../../src/components/shared-demo/sharedDemoActivityTracking.test.ts)
- [`src/components/shared-demo/sharedDemoLiveReportsDay.test.ts`](../../src/components/shared-demo/sharedDemoLiveReportsDay.test.ts)
- [`src/components/shared-demo/sharedDemoLocalBootstrap.test.ts`](../../src/components/shared-demo/sharedDemoLocalBootstrap.test.ts)
- [`src/components/shared-demo/sharedDemoOperationsFixture.test.ts`](../../src/components/shared-demo/sharedDemoOperationsFixture.test.ts)
- [`src/components/shared-demo/sharedDemoReportsFixture.test.ts`](../../src/components/shared-demo/sharedDemoReportsFixture.test.ts)
- [`src/components/shared-demo/sharedDemoRestoreOverlay.test.ts`](../../src/components/shared-demo/sharedDemoRestoreOverlay.test.ts)
- [`src/components/shared-demo/sharedDemoRuntimeCoordinator.test.ts`](../../src/components/shared-demo/sharedDemoRuntimeCoordinator.test.ts)
- [`src/components/shared-demo/sharedDemoStockNavigation.test.ts`](../../src/components/shared-demo/sharedDemoStockNavigation.test.ts)
- [`src/components/shared-demo/sharedDemoTransactionsFixture.test.ts`](../../src/components/shared-demo/sharedDemoTransactionsFixture.test.ts)
...
- [`src/components/states/not-found/NotFound.test.tsx`](../../src/components/states/not-found/NotFound.test.tsx)
...
- [`src/components/store-configuration/components/NotificationsView.test.tsx`](../../src/components/store-configuration/components/NotificationsView.test.tsx)
...
- [`src/components/store-configuration/hooks/useNotificationSubscriptions.test.tsx`](../../src/components/store-configuration/hooks/useNotificationSubscriptions.test.tsx)
...
- [`src/components/ui/table.test.tsx`](../../src/components/ui/table.test.tsx)
...
- [`src/contextTracking/docsWorkspaceTracking.test.ts`](../../src/contextTracking/docsWorkspaceTracking.test.ts)
- [`src/contexts/AppShellFullscreenContext.test.tsx`](../../src/contexts/AppShellFullscreenContext.test.tsx)
- [`src/contexts/ManagerElevationContext.test.tsx`](../../src/contexts/ManagerElevationContext.test.tsx)
- [`src/contexts/OnlineOrderContext.test.tsx`](../../src/contexts/OnlineOrderContext.test.tsx)
- [`src/contexts/ProductContext.test.tsx`](../../src/contexts/ProductContext.test.tsx)
- [`src/contexts/onlineOrderSessionOverlay.test.ts`](../../src/contexts/onlineOrderSessionOverlay.test.ts)
- [`src/design-system-build-config.test.ts`](../../src/design-system-build-config.test.ts)
- [`src/extensions/screenRedactExtension.test.ts`](../../src/extensions/screenRedactExtension.test.ts)
...
- [`src/hooks/useSharedDemoContext.test.ts`](../../src/hooks/useSharedDemoContext.test.ts)
- [`src/hooks/useSheetReturnPosition.test.tsx`](../../src/hooks/useSheetReturnPosition.test.tsx)
- [`src/hooks/useSheetScrollPreservation.test.tsx`](../../src/hooks/useSheetScrollPreservation.test.tsx)
- [`src/hooks/useStoreOperatingClock.test.tsx`](../../src/hooks/useStoreOperatingClock.test.tsx)
...
- [`src/lib/docs/scrollProgress.test.ts`](../../src/lib/docs/scrollProgress.test.ts)
...
- [`src/lib/errors/productArchiveFailure.test.ts`](../../src/lib/errors/productArchiveFailure.test.ts)
- [`src/lib/errors/runCommand.test.ts`](../../src/lib/errors/runCommand.test.ts)
- [`src/lib/errors/sharedDemoDenialObserver.test.ts`](../../src/lib/errors/sharedDemoDenialObserver.test.ts)
- [`src/lib/errors/sharedDemoSessionExpired.test.ts`](../../src/lib/errors/sharedDemoSessionExpired.test.ts)
...
- [`src/lib/marketing/landingFunnelClient.test.ts`](../../src/lib/marketing/landingFunnelClient.test.ts)
- [`src/lib/marketing/walkthroughRequestClient.test.ts`](../../src/lib/marketing/walkthroughRequestClient.test.ts)
...
- [`src/lib/pos/application/expectedTelemetryOutcome.test.ts`](../../src/lib/pos/application/expectedTelemetryOutcome.test.ts)
...
- [`src/lib/pos/application/useCases/openDrawer.test.ts`](../../src/lib/pos/application/useCases/openDrawer.test.ts)
...
- [`src/lib/pos/infrastructure/local/registerCatalogPinRuntime.test.ts`](../../src/lib/pos/infrastructure/local/registerCatalogPinRuntime.test.ts)
...
- [`src/lib/pos/infrastructure/local/registerSessionAuthorityBootstrap.test.ts`](../../src/lib/pos/infrastructure/local/registerSessionAuthorityBootstrap.test.ts)
- [`src/lib/pos/infrastructure/local/runtimeStatusPublisher.test.ts`](../../src/lib/pos/infrastructure/local/runtimeStatusPublisher.test.ts)
...
- [`src/lib/pos/infrastructure/local/syncGapDiagnosis.test.ts`](../../src/lib/pos/infrastructure/local/syncGapDiagnosis.test.ts)
...
- [`src/lib/pos/infrastructure/telemetry/loggerGateway.test.ts`](../../src/lib/pos/infrastructure/telemetry/loggerGateway.test.ts)
- [`src/lib/pos/infrastructure/telemetry/printAttemptTelemetry.test.ts`](../../src/lib/pos/infrastructure/telemetry/printAttemptTelemetry.test.ts)
- [`src/lib/pos/infrastructure/telemetry/runtimeCounters.test.ts`](../../src/lib/pos/infrastructure/telemetry/runtimeCounters.test.ts)
- [`src/lib/pos/infrastructure/telemetry/telemetryBuffer.test.ts`](../../src/lib/pos/infrastructure/telemetry/telemetryBuffer.test.ts)
- [`src/lib/pos/infrastructure/telemetry/telemetryContext.test.ts`](../../src/lib/pos/infrastructure/telemetry/telemetryContext.test.ts)
- [`src/lib/pos/infrastructure/telemetry/usePosClientTelemetryDrain.test.ts`](../../src/lib/pos/infrastructure/telemetry/usePosClientTelemetryDrain.test.ts)
...
- [`src/lib/pos/receipts/PosReceiptEmail.test.tsx`](../../src/lib/pos/receipts/PosReceiptEmail.test.tsx)
- [`src/lib/pos/toastService.telemetry.test.ts`](../../src/lib/pos/toastService.telemetry.test.ts)
...
- [`src/lib/sheetReturn.test.ts`](../../src/lib/sheetReturn.test.ts)
...
- [`src/routes/_authed/$orgUrlSlug/settings/waiver-passkey.test.tsx`](../../src/routes/_authed/$orgUrlSlug/settings/waiver-passkey.test.tsx)
...
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/pos.route.test.tsx`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/pos.route.test.tsx)
...
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/index.test.ts`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/index.test.ts)
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/items/$productSkuId.test.ts`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/items/$productSkuId.test.ts)
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/items/index.test.ts`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/items/index.test.ts)
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/weekly.lifecycle.test.tsx`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/weekly.lifecycle.test.tsx)
- [`src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/weekly.test.ts`](../../src/routes/_authed/$orgUrlSlug/store/$storeUrlSlug/reports/weekly.test.ts)
...
- [`src/routes/app.route.test.tsx`](../../src/routes/app.route.test.tsx)
...
- [`src/static-product-metadata.test.ts`](../../src/static-product-metadata.test.ts)
...
- [`src/tests/demo/journeyDate.test.ts`](../../src/tests/demo/journeyDate.test.ts)
- [`src/tests/demo/navigationCases.test.ts`](../../src/tests/demo/navigationCases.test.ts)
