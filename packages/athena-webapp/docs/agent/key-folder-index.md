...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 128 file(s); key children: -app-entry-route.tsx, -authed-layout.tsx, -authenticated-layout.tsx, -demo-presentation.ts, -index-route-view.tsx.
...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 46 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
