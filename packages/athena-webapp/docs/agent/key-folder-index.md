...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 55 file(s); key children: __root.tsx, _authed, _authed.tsx, index.tsx, join-team.index.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 208 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
