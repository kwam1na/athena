...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 56 file(s); key children: .DS_Store, __root.tsx, _authed, _authed.tsx, index.tsx.
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 464 file(s); key children: .DS_Store, GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 211 file(s); key children: .DS_Store, README.md, _generated, app.ts, auth.config.js.
