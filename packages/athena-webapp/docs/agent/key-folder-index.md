...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 722 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 40 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 906 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
