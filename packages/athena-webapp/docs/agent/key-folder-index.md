...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 540 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/components/operations`](../../src/components/operations) — Manager-queue and stock-adjustment workflows that share approval rails with other operational surfaces. Currently 15 file(s); key children: CommandApprovalDialog.test.tsx, CommandApprovalDialog.tsx, DailyCloseView.test.tsx, DailyCloseView.tsx, DailyOpeningView.test.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 416 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
