...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 621 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 19 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 565 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
