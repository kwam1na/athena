...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 519 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 71 file(s); key children: aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts, countries.ts.
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 6 file(s); key children: auth.ts, commandResult.test.ts, commandResult.ts, serviceIntake.ts, stockAdjustment.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 349 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
