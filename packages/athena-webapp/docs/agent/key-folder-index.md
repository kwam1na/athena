...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 297 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 61 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currency.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1051 file(s); key children: README.md, _generated, app.test.ts, app.ts, auth.
