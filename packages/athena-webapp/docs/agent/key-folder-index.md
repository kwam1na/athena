...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 569 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 114 file(s); key children: access, aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 446 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
