...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 616 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/components/operations`](../../src/components/operations) — Manager-queue and stock-adjustment workflows that share approval rails with other operational surfaces. Currently 27 file(s); key children: CommandApprovalDialog.test.tsx, CommandApprovalDialog.tsx, DailyCloseHistoryView.test.tsx, DailyCloseHistoryView.tsx, DailyCloseView.test.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 531 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
