...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 219 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
...
- [`convex/reporting`](../../convex/reporting) — Versioned facts, inventory valuation, replayable projections, activation, evidence, and store-scoped reporting reads. Currently 96 file(s); key children: access.test.ts, access.ts, activation.test.ts, activation.ts, attentionRules.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 773 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
