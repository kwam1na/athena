...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 723 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 264 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 909 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
