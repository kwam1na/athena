...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 287 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
