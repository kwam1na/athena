...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 184 file(s); key children: access, app-update, aws.ts, behaviorUtils.ts, browserFingerprint.ts.
