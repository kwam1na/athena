...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 131 file(s); key children: access, aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 503 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
