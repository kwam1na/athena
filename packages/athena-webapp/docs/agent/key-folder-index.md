...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 527 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 77 file(s); key children: aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts, countries.ts.
...
- [`convex/workflowTraces`](../../convex/workflowTraces) — Shared workflow trace creation, lookup, presentation, and adapter helpers. Currently 10 file(s); key children: adapters, core.ts, presentation.test.ts, presentation.ts, public.ts.
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 357 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
