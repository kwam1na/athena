...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1032 file(s); key children: README.md, _generated, app.test.ts, app.ts, auth.
