...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 255 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 39 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 837 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
