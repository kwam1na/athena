...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 611 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`src/hooks`](../../src/hooks) — React hooks that fan out auth, shell, and feature state. Currently 45 file(s); key children: use-image-upload.ts, use-mobile.tsx, use-navigate-back.ts, use-navigation-keyboard-shortcuts.ts, use-pagination-persistence.ts.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 187 file(s); key children: access, app-update, aws.ts, behaviorUtils.ts, browserFingerprint.ts.
