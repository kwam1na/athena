...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 73 file(s); key children: aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts, countries.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 350 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
