...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 810 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 69 file(s); key children: agentHarness, approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1163 file(s); key children: README.md, _generated, agentHarness, app.test.ts, app.ts.
