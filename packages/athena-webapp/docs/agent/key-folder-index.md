...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 813 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1177 file(s); key children: README.md, _generated, agentHarness, app.test.ts, app.ts.
