...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1179 file(s); key children: README.md, _generated, agentHarness, app.test.ts, app.ts.
