...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 170 file(s); key children: access, aws.ts, behaviorUtils.ts, browserFingerprint.ts, constants.ts.
