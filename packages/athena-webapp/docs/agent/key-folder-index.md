...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 254 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 816 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
