...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 52 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1054 file(s); key children: README.md, _generated, app.test.ts, app.ts, auth.
