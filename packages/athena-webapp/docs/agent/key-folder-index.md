...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 82 file(s); key children: agentHarness, approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts.
