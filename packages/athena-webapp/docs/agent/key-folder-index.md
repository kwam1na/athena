...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 148 file(s); key children: -app-entry-route.tsx, -authed-layout.tsx, -authenticated-layout.tsx, -demo-presentation.ts, -docs-back-link.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 967 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
