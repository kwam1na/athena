...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 269 file(s); key children: access, app-messages, app-update, auth, aws.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 941 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
