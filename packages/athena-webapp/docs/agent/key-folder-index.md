...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 652 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`convex/reporting`](../../convex/reporting) — Versioned facts, inventory valuation, replayable projections, activation, evidence, and store-scoped reporting reads. Currently 99 file(s); key children: access.test.ts, access.ts, activation.test.ts, activation.ts, attentionRules.test.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 776 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
