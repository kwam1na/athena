...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 87 file(s); key children: __root.tsx, _authed, _authed.test.tsx, _authed.tsx, athena-boundaries.tsx.
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 595 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
