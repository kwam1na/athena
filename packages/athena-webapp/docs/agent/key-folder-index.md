...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 335 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
