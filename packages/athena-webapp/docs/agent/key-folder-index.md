...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 10 file(s); key children: auth.ts, commandResult.test.ts, commandResult.ts, registerSessionStatus.test.ts, registerSessionStatus.ts.
