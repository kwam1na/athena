...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 58 file(s); key children: __root.tsx, _authed, _authed.tsx, index.tsx, join-team.index.tsx.
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 471 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 241 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
