...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 134 file(s); key children: -app-entry-route.tsx, -authed-layout.tsx, -authenticated-layout.tsx, -demo-presentation.ts, -index-route-view.tsx.
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 784 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`src/hooks`](../../src/hooks) — React hooks that fan out auth, shell, and feature state. Currently 51 file(s); key children: use-image-upload.ts, use-mobile.tsx, use-navigate-back.ts, use-navigation-keyboard-shortcuts.ts, use-pagination-persistence.test.ts.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 271 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 48 file(s); key children: approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts.
...
- [`convex/reports`](../../convex/reports) — Canonical fact ledger, the deterministic day fold, sweeper-maintained day/SKU/rollup read models, source-truth verification, and store-scoped reporting reads. Currently 47 file(s); key children: access.test.ts, access.ts, contract.test.ts, customRange.test.ts, customRange.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 922 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
