...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 533 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 12 file(s); key children: auth.ts, commandResult.test.ts, commandResult.ts, currencyFormatter.test.ts, currencyFormatter.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 364 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
