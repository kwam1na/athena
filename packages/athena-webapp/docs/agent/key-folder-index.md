...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 535 file(s); key children: GenericComboBox.tsx, Navbar.tsx, OrganizationView.tsx, OrganizationsView.tsx, PermissionGate.tsx.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 410 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
