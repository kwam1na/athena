...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 113 file(s); key children: -authed-layout.tsx, -index-route-view.tsx, -public-layout.tsx, -root-page-search.ts, __root.test.ts.
