...
- [`src/routes`](../../src/routes) — TanStack route entrypoints and authenticated shells. Currently 117 file(s); key children: -authed-layout.tsx, -index-route-view.tsx, -public-layout.tsx, -root-page-search.ts, __root.test.ts.
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 705 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 259 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 898 file(s); key children: README.md, _generated, app.ts, auth, auth.config.js.
