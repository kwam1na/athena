...
- [`src/components`](../../src/components) — UI components, views, and package-local feature widgets. Currently 826 file(s); key children: GenericComboBox.tsx, Navbar.test.tsx, Navbar.tsx, OrganizationView.test.tsx, OrganizationView.tsx.
...
- [`src/lib`](../../src/lib) — Shared frontend helpers, schemas, and package utilities. Currently 313 file(s); key children: access, app-messages, app-update, aws.ts, behaviorUtils.ts.
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 88 file(s); key children: agentHarness, approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts.
...
- [`convex/stockOps`](../../convex/stockOps) — Stock-adjustment, procurement, replenishment, receiving, and vendor flows layered over inventory state. Currently 20 file(s); key children: access.test.ts, access.ts, adjustments.test.ts, adjustments.ts, agentCapabilities.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1283 file(s); key children: README.md, _generated, agentHarness, app.test.ts, app.ts.
