...
- [`convex/workflowTraces`](../../convex/workflowTraces) — Shared workflow trace creation, lookup, presentation, and adapter helpers. Currently 8 file(s); key children: adapters, core.ts, presentation.test.ts, presentation.ts, public.ts.
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 330 file(s); key children: README.md, _generated, app.ts, auth.config.js, auth.ts.
