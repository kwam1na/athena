...
- [`shared`](../../shared) — Browser-safe helpers shared with Convex-backed workflows. Currently 85 file(s); key children: agentHarness, approvalPolicy.ts, auth.ts, commandResult.test.ts, commandResult.ts.
...
- [`convex`](../../convex) — Convex functions, HTTP composition, schemas, and backend tests. Currently 1187 file(s); key children: README.md, _generated, agentHarness, app.test.ts, app.ts.
