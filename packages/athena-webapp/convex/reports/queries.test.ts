...
describe("reports module public surface", () => {
  ...
  it("registers exactly the intended public functions", async () => {
    ...
    expect(internalNames.sort()).toEqual([
      ...
      "pipelineDays.foldOneDay",
      "pipelineDays.recordDayFailure",
      "pipelineDays.runDay",
      "pipelineDispatch.dispatchAccept",
      "pipelineDispatch.dispatchCloseEvidence",
      "pipelineDispatch.dispatchCurrent",
      "pipelineDispatch.dispatchDays",
      "pipelineDispatch.dispatchInventory",
      "pipelineDispatch.dispatchLegacy",
      "pipelineDispatch.dispatchOverview",
      "pipelineDispatch.dispatchRefresh",
      "pipelineDispatch.dispatchResolveWeekDate",
      "pipelineDispatch.dispatchRetention",
      "pipelineDispatch.dispatchRollup",
      "pipelineDispatch.dispatchSummaryRanges",
      "pipelineDispatch.dispatchWeeklyRecovery",
      "pipelineDispatch.legacyStoreSweep",
      "pipelineDispatch.maintenance",
      "pipelineMigration.activate",
      "pipelineMigration.beginMigration",
      "pipelineMigration.migrationStatus",
      "pipelineMigration.recordMigrationFailure",
      "pipelineMigration.resumeAfterProof",
      "pipelineMigration.runMigration",
      "pipelineMigration.stepMigration",
      "pipelineRange.applySummaryBatch",
      "pipelineRange.dispatchStore",
      "pipelineRange.recordSummaryFailure",
      "pipelineRange.runSummaryBatch",
      "pipelineRetention.applyRetention",
      "pipelineRetention.recordRetentionFailure",
      "pipelineRetention.runRetention",
      "pipelineWeekly.applyAccept",
      "pipelineWeekly.applyCurrent",
      "pipelineWeekly.applyRefresh",
      "pipelineWeekly.applyResolveWeekDate",
      "pipelineWeekly.runAccept",
      "pipelineWeekly.runCurrent",
      "pipelineWeekly.runRefresh",
      "pipelineWeekly.runResolveWeekDate",
      "pipelineWeeklyRecovery.runRecovery",
      "pipelineWorkers.applyCloseEvidence",
      "pipelineWorkers.applyOverview",
      "pipelineWorkers.recordWorkerFailure",
      "pipelineWorkers.runCloseEvidence",
      "pipelineWorkers.runOverview",
      "reseed.reseedStoreReporting",
      "rollupWorkers.applyRollup",
      "rollupWorkers.recordRollupFailure",
      "rollupWorkers.runRollup",
      ...
      "weeklyInventoryWorker.applyInventory",
      "weeklyInventoryWorker.runInventory",
