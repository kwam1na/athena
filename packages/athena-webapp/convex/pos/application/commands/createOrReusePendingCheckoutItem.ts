...
export async function recordPendingCheckoutItemEvidenceCorrection(
  ...
  await recordOperationalEventWithCtx(ctx, {
    ...
    metadata: {
      lookupCode: updatedItem.lookupCode,
      pendingCheckoutItemId: updatedItem._id,
      posTransactionId: args.posTransactionId,
      price: updatedItem.provisionalPrice,
      provisionalProductId: updatedItem.provisionalProductId,
      provisionalProductSkuId: updatedItem.provisionalProductSkuId,
      quantityDelta: args.quantityDelta,
      reason: args.reason,
      reviewPriority: updatedItem.reviewPriority,
