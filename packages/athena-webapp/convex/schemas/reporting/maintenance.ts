...
export const reportingBackfillAuthorizationGrantSchema = v.object({
  organizationId: v.id("organization"),
  storeId: v.id("store"),
  sourceScope: v.literal("pos"),
  migrationPurpose: v.literal("reports_financial_truth_reset_backfill"),
  contractVersion: v.number(),
  timezoneContentHash: v.string(),
  requestNonce: v.string(),
  envelopeHash: v.string(),
  identitySubject: v.string(),
  athenaUserId: v.id("athenaUser"),
  membershipId: v.id("organizationMember"),
  roleSnapshot: v.literal("full_admin"),
...
export const reportingPosSourceReconciliationSchema = v.object({
  ...
  sourceManifestDigest: v.optional(v.string()),
  sourceManifestId: v.optional(v.id("reportingBackfillApplyManifest")),
  ...
  journalCount: v.optional(v.number()),
  journalMatchedCount: v.optional(v.number()),
  authoritativeSourceCount: v.optional(v.number()),
  authoritativeSourceDigest: v.optional(v.string()),
  status: v.union(
    v.literal("building"),
    v.literal("verified"),
    v.literal("blocked"),
  ...
  factCount: v.number(),
  sourceAmountMinor: v.number(),
  factAmountMinor: v.number(),
  sourceQuantity: v.number(),
  factQuantity: v.number(),
  unexplainedCount: v.number(),
  orphanPaymentCorrectionCount: v.optional(v.number()),
...
export const reportingRunSchema = v.object({
  ...
  lifecycleJournalTerminalId: v.optional(v.string()),
  lifecycleJournalTerminalRecordedAt: v.optional(v.number()),
  backfillApplyManifestId: v.optional(v.id("reportingBackfillApplyManifest")),
...
export const reportingBackfillPreviewItemSchema = v.object({
  ...
  exclusionReason: v.optional(v.literal("orphan_payment_correction")),
  createdAt: v.number(),
  policyId: v.optional(v.id("reportingHistoricalInterpretationPolicy")),
  policyHash: v.optional(v.string()),
