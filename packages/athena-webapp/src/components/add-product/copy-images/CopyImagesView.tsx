...
export function buildCopyImagesSkuUpdate(
  ...
  return {
    ...
    update: {
      images: source.images.map((image) => image.preview),
    },
  };
}
...
const ProductVariantsTable = () => {
  ...
  const updateSkuImages = useMutation(api.inventory.productSku.update);
  ...
  const copyImagesFromSourceToDestination = async () => {
    ...
    try {
      ...
      await updateSkuImages(buildCopyImagesSkuUpdate(source, destination));
