import { ALL_COUNTRIES } from "./geography/countries";
import { accraNeighborhoods, ghanaRegions } from "./geography/ghana";

/**
 * Structural shape of the stored delivery address. Declared here rather than
 * imported from the package-root `types` module so this file stays free of the
 * Convex schema graph and can be pulled into the browser bundle. It matches
 * `addressSchema` in `convex/schemas/storeFront/onlineOrder`.
 */
 ...
 */
export const formatDeliveryAddress = (address: PostalAddress) => {
