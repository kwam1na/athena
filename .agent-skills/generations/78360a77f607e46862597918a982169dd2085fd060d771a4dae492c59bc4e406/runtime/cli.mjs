...
${result.stderr}`.slice(-4e3)}`);
  ...
  if (snapshots === void 0 || digestCanonical4(snapshots.map(({ path: path21, sha256 }) => ({ path: path21, sha256 }))) !== binding.outputsDigest) return fail("check_output_missing", "Declared outputs changed before evidence retention.");
