...
declare const RUN_EVENT_KINDS: readonly ["run.started", "run.ended", "ticket.read", "posture.declared", "lens.selected", "review.round.opened", "review.round.closed", "command.completed", "gate.reported", "pr.opened", "blocker.recorded", "decision.recorded", "compounding.recorded", "context.saved", "action.intent", "action.observed"];
 ...
 */
declare function evaluateRunJournal(events: readonly RunEvent[], treeSha?: string, mandatedLensIds?: readonly string[]): RunJournalEvaluation;
